...
class  UBehavior_ChangeRemoteBehaviorSequenceState(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UBehaviorBase", UBehaviorBase_Data),
		("UBehavior_ChangeRemoteBehaviorSequenceState", UBehavior_ChangeRemoteBehaviorSequenceState_Data),
	]
...
class  AGearboxCameraBasic_Data(Structure):
	_fields_ = [
		("VfTable_IInterfaceGearboxCamera", FPointer),
	]
...
class  UGearboxSeqAct_DestroyPopulationActors(Structure):
	_fields_ = [
		...
		("UGearboxSeqAct_DestroyPopulationActors", UGearboxSeqAct_DestroyPopulationActors_Data),
	]
...
class  UGearboxSeqAct_ResetPopulationCount(Structure):
	_fields_ = [
		...
		("USequenceOp", USequenceOp_Data),
		("USequenceAction", USequenceAction_Data),
		("UGearboxSeqAct_ResetPopulationCount", UGearboxSeqAct_ResetPopulationCount_Data),
	]
...
class  UGFxMovieStateCustom_Data(Structure):
	_fields_ = [
		("CustomStates", TArray_FMovieStateData),
	]
...
class  UNoContextNeededAttributeContextResolver(Structure):
	_fields_ = [
		...
		("UNoContextNeededAttributeContextResolver", UNoContextNeededAttributeContextResolver_Data),
	]
...
class  UObjectFunctionAttributeValueResolver(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UAttributeValueResolver", UAttributeValueResolver_Data),
		("UObjectFunctionAttributeValueResolver", UObjectFunctionAttributeValueResolver_Data),
	]
...
class  UPopulationEncounterRenderingComponent(Structure):
	_fields_ = [
		...
		("UActorComponent", UActorComponent_Data),
		("UPrimitiveComponent", UPrimitiveComponent_Data),
		("UPopulationEncounterRenderingComponent", UPopulationEncounterRenderingComponent_Data),
	]
...
class  UPopulationOpportunityCombatRenderingComponent(Structure):
	_fields_ = [
		...
		("UActorComponent", UActorComponent_Data),
		("UPrimitiveComponent", UPrimitiveComponent_Data),
		("UPopulationOpportunityCombatRenderingComponent", UPopulationOpportunityCombatRenderingComponent_Data),
	]
...
class  UPopulationSpawnedActorTagDefinition(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UGBXDefinition", UGBXDefinition_Data),
		("UPopulationSpawnedActorTagDefinition", UPopulationSpawnedActorTagDefinition_Data),
	]
...
class  USpecialMoveRandom_Data(Structure):
	_fields_ = [
		("RandomList", TArray_FSMRandomPair),
	]
...
class  AWireManager_Data(Structure):
	_fields_ = [
		("DefaultMaterial", POINTER(UMaterialInterface)),
	]
...
class  UBestTargetAttributeContextResolver(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UAttributeContextResolver", UAttributeContextResolver_Data),
		("UBestTargetAttributeContextResolver", UBestTargetAttributeContextResolver_Data),
	]
...
class  UGearboxMindAttributeContextResolver(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UAttributeContextResolver", UAttributeContextResolver_Data),
		("UGearboxMindAttributeContextResolver", UGearboxMindAttributeContextResolver_Data),
	]
...
class  USearchDirection_OppositeMyFacingDirection(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("USearchDirection", USearchDirection_Data),
		("USearchDirection_OppositeMyFacingDirection", USearchDirection_OppositeMyFacingDirection_Data),
	]
...
class  USearchDirection_OppositeTargetsFacingDirection(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("USearchDirection", USearchDirection_Data),
		("USearchDirection_OppositeTargetsFacingDirection", USearchDirection_OppositeTargetsFacingDirection_Data),
	]
...
class  USearchDirection_TargetsFacingDirection(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("USearchDirection", USearchDirection_Data),
		("USearchDirection_TargetsFacingDirection", USearchDirection_TargetsFacingDirection_Data),
	]
...
class  UTargetIteratorPrioritizeTargetsIAmExposedTo(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UTargetIterator", UTargetIterator_Data),
		("UTargetIteratorPrioritizeTargetsIAmExposedTo", UTargetIteratorPrioritizeTargetsIAmExposedTo_Data),
	]
...
class  UTargetIteratorPrioritizeExposedTargets(Structure):
	_fields_ = [
		...
		("UTargetIterator", UTargetIterator_Data),
		("UTI_Prioritize", UTI_Prioritize_Data),
		("UTargetIteratorPrioritizeExposedTargets", UTargetIteratorPrioritizeExposedTargets_Data),
	]
...
class  UTargetIteratorPrioritizeHumanTargets(Structure):
	_fields_ = [
		...
		("UTargetIterator", UTargetIterator_Data),
		("UTI_Prioritize", UTI_Prioritize_Data),
		("UTargetIteratorPrioritizeHumanTargets", UTargetIteratorPrioritizeHumanTargets_Data),
	]
...
class  UTargetIteratorPrioritizeNearbyTarget(Structure):
	_fields_ = [
		...
		("UTargetIterator", UTargetIterator_Data),
		("UTI_Prioritize", UTI_Prioritize_Data),
		("UTargetIteratorPrioritizeNearbyTarget", UTargetIteratorPrioritizeNearbyTarget_Data),
	]
...
class  UTargetIteratorPrioritizePreviousTarget(Structure):
	_fields_ = [
		...
		("UTargetIterator", UTargetIterator_Data),
		("UTI_Prioritize", UTI_Prioritize_Data),
		("UTargetIteratorPrioritizePreviousTarget", UTargetIteratorPrioritizePreviousTarget_Data),
	]
...
class  UTargetIteratorPrioritizeTargetNotBeingShotAt(Structure):
	_fields_ = [
		...
		("UTargetIterator", UTargetIterator_Data),
		("UTI_Prioritize", UTI_Prioritize_Data),
		("UTargetIteratorPrioritizeTargetNotBeingShotAt", UTargetIteratorPrioritizeTargetNotBeingShotAt_Data),
	]
...
class  UTargetIteratorPrioritizeTargetWhoShootsAtMe(Structure):
	_fields_ = [
		...
		("UTargetIterator", UTargetIterator_Data),
		("UTI_Prioritize", UTI_Prioritize_Data),
		("UTargetIteratorPrioritizeTargetWhoShootsAtMe", UTargetIteratorPrioritizeTargetWhoShootsAtMe_Data),
	]
...
class  UGearboxSeqAct_PopulationOpportunityLink(Structure):
	_fields_ = [
		...
		("USequenceAction", USequenceAction_Data),
		("USeqAct_Latent", USeqAct_Latent_Data),
		("UGearboxSeqAct_PopulationOpportunityLink", UGearboxSeqAct_PopulationOpportunityLink_Data),
	]
...
class  UPopulationFactoryPopulationDefinition(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UPopulationFactory", UPopulationFactory_Data),
		("UPopulationFactoryPopulationDefinition", UPopulationFactoryPopulationDefinition_Data),
	]
...
class  UPopulationOpportunityAreaRenderingComponent(Structure):
	_fields_ = [
		...
		("UActorComponent", UActorComponent_Data),
		("UPrimitiveComponent", UPrimitiveComponent_Data),
		("UPopulationOpportunityAreaRenderingComponent", UPopulationOpportunityAreaRenderingComponent_Data),
	]
...
class  UPopulationOpportunityAttributeContextResolver(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UAttributeContextResolver", UAttributeContextResolver_Data),
		("UPopulationOpportunityAttributeContextResolver", UPopulationOpportunityAttributeContextResolver_Data),
	]
...
class  UPopulationOpportunityPointRenderingComponent(Structure):
	_fields_ = [
		...
		("UActorComponent", UActorComponent_Data),
		("UPrimitiveComponent", UPrimitiveComponent_Data),
		("UPopulationOpportunityPointRenderingComponent", UPopulationOpportunityPointRenderingComponent_Data),
	]
...
class  UBehaviorSequenceCustomEnableCondition(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UBehaviorSequenceCustomEnableCondition", UBehaviorSequenceCustomEnableCondition_Data),
	]
...
class  UBehaviorSequenceEnableByMultipleConditions(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UBehaviorSequenceCustomEnableCondition", UBehaviorSequenceCustomEnableCondition_Data),
		("UBehaviorSequenceEnableByMultipleConditions", UBehaviorSequenceEnableByMultipleConditions_Data),
	]
...
class  UGearboxDialogAct_ObjectParameterSwitch(Structure):
	_fields_ = [
		...
		("UGearboxDialogNode", UGearboxDialogNode_Data),
		("UGearboxDialogAction", UGearboxDialogAction_Data),
		("UGearboxDialogAct_ObjectParameterSwitch", UGearboxDialogAct_ObjectParameterSwitch_Data),
	]
...
class  UAIComponentAttributeContextResolver(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UAttributeContextResolver", UAttributeContextResolver_Data),
		("UAIComponentAttributeContextResolver", UAIComponentAttributeContextResolver_Data),
	]
...
class  UBehavior_ChangeAnyBehaviorSequenceState(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UBehaviorBase", UBehaviorBase_Data),
		("UBehavior_ChangeAnyBehaviorSequenceState", UBehavior_ChangeAnyBehaviorSequenceState_Data),
	]
...
class  UBehavior_ChangeLocalBehaviorSequenceState(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UBehaviorBase", UBehaviorBase_Data),
		("UBehavior_ChangeLocalBehaviorSequenceState", UBehavior_ChangeLocalBehaviorSequenceState_Data),
	]
...
class  UGearboxSeqAct_CameraShake_Data(Structure):
	_fields_ = [
		("CameraShake", FGearboxViewShakeInfo),
	]
...
class  UPopulationMasterAttributeContextResolver(Structure):
	_fields_ = [
		("UObject", UObject_Data),
		("UAttributeContextResolver", UAttributeContextResolver_Data),
		("UPopulationMasterAttributeContextResolver", UPopulationMasterAttributeContextResolver_Data),
	]
...
BL2SDK.g_loadedClasses += [("UAttributeExpressionEvaluator", 2920, "UExpressionEvaluator")]
BL2SDK.g_loadedClasses += [("UBehavior_CallFunction", 2922, "UBehaviorBase")]
BL2SDK.g_loadedClasses += [("UBehavior_ChangeRemoteBehaviorSequenceState", 2924, "UBehaviorBase")]
...
BL2SDK.g_loadedClasses += [("UCompoundExpressionEvaluator", 2934, "UExpressionEvaluator")]
BL2SDK.g_loadedClasses += [("UConditionalAttributeValueResolver", 2936, "UAttributeValueResolver")]
BL2SDK.g_loadedClasses += [("UConstantAttributeValueResolver", 2938, "UAttributeValueResolver")]
BL2SDK.g_loadedClasses += [("UConstraintAttributeValueResolver", 2940, "UAttributeValueResolver")]
...
BL2SDK.g_loadedClasses += [("UPawnMoveLocationRequest", 2976, "UGearboxLocationRequest")]
...
BL2SDK.g_loadedClasses += [("AGearboxPlayerReplicationInfo", 2984, "APlayerReplicationInfo")]
...
BL2SDK.g_loadedClasses += [("UGearboxSeqAct_DestroyPopulationActors", 2990, "USeqAct_Latent")]
BL2SDK.g_loadedClasses += [("UGearboxSeqAct_ResetPopulationCount", 2992, "USequenceAction")]
BL2SDK.g_loadedClasses += [("UGearboxSkeletalMeshComponent", 2994, "USkeletalMeshComponent")]
BL2SDK.g_loadedClasses += [("UGearboxStaticMeshComponent", 2996, "UStaticMeshComponent")]
...
BL2SDK.g_loadedClasses += [("UGearboxEULAGFxMovieDefinition", 3004, "UGFxMovieDefinition")]
...
BL2SDK.g_loadedClasses += [("UGFxMovieDrawStyleComponent", 3012, "UGFxMovieDrawStyleRTT")]
BL2SDK.g_loadedClasses += [("UGFxMovieDrawStyleMesh", 3014, "UGFxMovieDrawStyleComponent")]
BL2SDK.g_loadedClasses += [("UGFxMovieDrawStyleSprite", 3016, "UGFxMovieDrawStyleComponent")]
BL2SDK.g_loadedClasses += [("UGFxMovieDrawStyleSplitscreen", 3018, "UGFxMovieDrawStyle")]
...
BL2SDK.g_loadedClasses += [("UNoContextNeededAttributeContextResolver", 3044, "UAttributeContextResolver")]
BL2SDK.g_loadedClasses += [("UNounAttributeValueResolver", 3046, "UAttributeValueResolver")]
BL2SDK.g_loadedClasses += [("UObjectFunctionAttributeValueResolver", 3048, "UAttributeValueResolver")]
BL2SDK.g_loadedClasses += [("UObjectPropertyContextResolver", 3050, "UAttributeContextResolver")]
BL2SDK.g_loadedClasses += [("UPhysicsStateExpressionEvaluator", 3052, "UExpressionEvaluator")]
...
BL2SDK.g_loadedClasses += [("UPopulationEncounterRenderingComponent", 3060, "UPrimitiveComponent")]
BL2SDK.g_loadedClasses += [("UPopulationOpportunityCombatRenderingComponent", 3062, "UPrimitiveComponent")]
BL2SDK.g_loadedClasses += [("UPopulationSpawnedActorTagDefinition", 3064, "UGBXDefinition")]
BL2SDK.g_loadedClasses += [("UPopUpDebugBarGraph", 3066, "UObject")]
BL2SDK.g_loadedClasses += [("URandomAttributeValueResolver", 3068, "UAttributeValueResolver")]
...
BL2SDK.g_loadedClasses += [("USimpleMathValueResolver", 3086, "UAttributeValueResolver")]
...
BL2SDK.g_loadedClasses += [("USpecialMoveExpressionList", 3092, "USpecialMoveDefinition")]
...
BL2SDK.g_loadedClasses += [("UAIResourceExpressionEvaluator", 3132, "UExpressionEvaluator")]
BL2SDK.g_loadedClasses += [("UAllegianceExpressionEvaluator", 3134, "UExpressionEvaluator")]
BL2SDK.g_loadedClasses += [("UAwarenessZoneCollectionDefinition", 3136, "UGBXDefinition")]
...
BL2SDK.g_loadedClasses += [("UBestTargetAttributeContextResolver", 3144, "UAttributeContextResolver")]
...
BL2SDK.g_loadedClasses += [("UExposureUtilityBasicCaching", 3152, "UExposureUtilityBase")]
BL2SDK.g_loadedClasses += [("UExposureUtilityFixedCost", 3154, "UExposureUtilityBasicCaching")]
...
BL2SDK.g_loadedClasses += [("UObjectFunctionFlagValueResolver", 3186, "UFlagValueResolver")]
BL2SDK.g_loadedClasses += [("UObjectPropertyFlagValueResolver", 3188, "UFlagValueResolver")]
...
BL2SDK.g_loadedClasses += [("UGearboxAIMoveNodeRenderComponent", 3200, "UPrimitiveComponent")]
BL2SDK.g_loadedClasses += [("UGearboxCoverStateManager", 3202, "UObject")]
BL2SDK.g_loadedClasses += [("UGearboxMindAttributeContextResolver", 3204, "UAttributeContextResolver")]
...
BL2SDK.g_loadedClasses += [("USearchDirection_AwayFromTarget", 3248, "USearchDirection")]
BL2SDK.g_loadedClasses += [("USearchDirection_MyFacingDirection", 3250, "USearchDirection")]
BL2SDK.g_loadedClasses += [("USearchDirection_OppositeMyFacingDirection", 3252, "USearchDirection")]
BL2SDK.g_loadedClasses += [("USearchDirection_OppositeTargetsFacingDirection", 3254, "USearchDirection")]
BL2SDK.g_loadedClasses += [("USearchDirection_RandomLeftOrRight", 3256, "USearchDirection")]
BL2SDK.g_loadedClasses += [("USearchDirection_TargetsFacingDirection", 3258, "USearchDirection")]
...
BL2SDK.g_loadedClasses += [("UTargetIteratorCalculateDistance", 3284, "UTargetIterator")]
BL2SDK.g_loadedClasses += [("UTargetIteratorCalculateExposure", 3286, "UTargetIterator")]
BL2SDK.g_loadedClasses += [("UTargetIteratorCheckAwareness", 3288, "UTargetIterator")]
BL2SDK.g_loadedClasses += [("UTargetIteratorCheckRemoveTarget", 3290, "UTargetIterator")]
BL2SDK.g_loadedClasses += [("UTargetIteratorForgetAboutTarget", 3292, "UTargetIterator")]
BL2SDK.g_loadedClasses += [("UTargetIteratorPrioritizeTargetsIAmExposedTo", 3294, "UTargetIterator")]
BL2SDK.g_loadedClasses += [("UTI_Calc", 3296, "UTargetIterator")]
BL2SDK.g_loadedClasses += [("UTI_Prioritize", 3298, "UTargetIterator")]
BL2SDK.g_loadedClasses += [("UTargetIteratorPrioritizeExposedTargets", 3300, "UTI_Prioritize")]
BL2SDK.g_loadedClasses += [("UTargetIteratorPrioritizeHumanTargets", 3302, "UTI_Prioritize")]
BL2SDK.g_loadedClasses += [("UTargetIteratorPrioritizeNearbyTarget", 3304, "UTI_Prioritize")]
BL2SDK.g_loadedClasses += [("UTargetIteratorPrioritizePreviousTarget", 3306, "UTI_Prioritize")]
BL2SDK.g_loadedClasses += [("UTargetIteratorPrioritizeTargetNotBeingShotAt", 3308, "UTI_Prioritize")]
BL2SDK.g_loadedClasses += [("UTargetIteratorPrioritizeTargetWhoShootsAtMe", 3310, "UTI_Prioritize")]
...
BL2SDK.g_loadedClasses += [("UGearboxSeqAct_PopulationOpportunityLink", 3316, "USeqAct_Latent")]
...
BL2SDK.g_loadedClasses += [("UPopulationFactoryPopulationDefinition", 3326, "UPopulationFactory")]
BL2SDK.g_loadedClasses += [("UPopulationMaster", 3328, "UObject")]
BL2SDK.g_loadedClasses += [("APopulationOpportunity", 3330, "AInfo")]
BL2SDK.g_loadedClasses += [("APopulationOpportunityArea", 3332, "APopulationOpportunity")]
BL2SDK.g_loadedClasses += [("APopulationOpportunityCloner", 3334, "APopulationOpportunity")]
BL2SDK.g_loadedClasses += [("APopulationOpportunityCombat", 3336, "APopulationOpportunity")]
BL2SDK.g_loadedClasses += [("APopulationOpportunityPoint", 3338, "APopulationOpportunity")]
BL2SDK.g_loadedClasses += [("UPopulationOpportunityAreaRenderingComponent", 3340, "UPrimitiveComponent")]
BL2SDK.g_loadedClasses += [("UPopulationOpportunityAttributeContextResolver", 3342, "UAttributeContextResolver")]
BL2SDK.g_loadedClasses += [("UPopulationOpportunityPointRenderingComponent", 3344, "UPrimitiveComponent")]
BL2SDK.g_loadedClasses += [("APopulationPoint", 3346, "AActor")]
BL2SDK.g_loadedClasses += [("APopulationPoint_Dynamic", 3348, "APopulationPoint")]
BL2SDK.g_loadedClasses += [("UPopulationPointRenderingComponent", 3350, "UPrimitiveComponent")]
...
BL2SDK.g_loadedClasses += [("UAIBehaviorProviderDefinition", 3368, "UBehaviorProviderDefinition")]
BL2SDK.g_loadedClasses += [("UBehaviorSequenceCustomEnableCondition", 3370, "UObject")]
BL2SDK.g_loadedClasses += [("UBehaviorSequenceEnableByMultipleConditions", 3372, "UBehaviorSequenceCustomEnableCondition")]
...
BL2SDK.g_loadedClasses += [("UGearboxDialogAct_ObjectParameterSwitch", 3414, "UGearboxDialogAction")]
BL2SDK.g_loadedClasses += [("UGearboxDialogNonTemplateAction", 3416, "UGearboxDialogAction")]
BL2SDK.g_loadedClasses += [("UGearboxDialogAct_Talk", 3418, "UGearboxDialogNonTemplateAction")]
BL2SDK.g_loadedClasses += [("UGearboxDialogTemplateAction", 3420, "UGearboxDialogAction")]
BL2SDK.g_loadedClasses += [("UGearboxDialogAct_Trigger", 3422, "UGearboxDialogTemplateAction")]
...
BL2SDK.g_loadedClasses += [("UGearboxDialogVar_Instigator", 3430, "UGearboxDialogVariable")]
BL2SDK.g_loadedClasses += [("UGearboxDialogVar_LastTalker", 3432, "UGearboxDialogVariable")]
BL2SDK.g_loadedClasses += [("UGearboxDialogVar_NameTag", 3434, "UGearboxDialogVariable")]
...
BL2SDK.g_loadedClasses += [("UGearboxSeqAct_TriggerDialogName", 3444, "UGearboxSeqAct_TriggerDialog")]
...
BL2SDK.g_loadedClasses += [("UActorAttributeContextResolver", 39162, "UAttributeContextResolver")]
BL2SDK.g_loadedClasses += [("UAIComponentAttributeContextResolver", 39278, "UAttributeContextResolver")]
...
BL2SDK.g_loadedClasses += [("UBehavior_ChangeAnyBehaviorSequenceState", 39746, "UBehaviorBase")]
BL2SDK.g_loadedClasses += [("UBehavior_ChangeLocalBehaviorSequenceState", 39762, "UBehaviorBase")]
...
BL2SDK.g_loadedClasses += [("UBehavior_GetObjectParam", 39905, "UParameterBehaviorBase")]
BL2SDK.g_loadedClasses += [("UBehavior_GetVectorParam", 39919, "UParameterBehaviorBase")]
BL2SDK.g_loadedClasses += [("UBehavior_InterpolateFloatOverTime", 39938, "UBehaviorBase")]
...
BL2SDK.g_loadedClasses += [("UBehavior_SetObjectParam", 40121, "UParameterBehaviorBase")]
BL2SDK.g_loadedClasses += [("UBehavior_SetVectorParam", 40132, "UParameterBehaviorBase")]
...
BL2SDK.g_loadedClasses += [("UCameraModifierCrossfade", 40602, "UGearboxCameraModifier")]
...
BL2SDK.g_loadedClasses += [("UGFxMovieDrawStyleInstanceData", 43594, "UGFxMovieDrawStyleRTT")]
BL2SDK.g_loadedClasses += [("USeqEvent_AllSpawned", 43898, "USequenceEvent")]
BL2SDK.g_loadedClasses += [("UPopulationMasterAttributeContextResolver", 44207, "UAttributeContextResolver")]
...
BL2SDK.g_loadedClasses += [("ASkeletalMeshActorGBXMatinee", 44655, "ASkeletalMeshActor")]
