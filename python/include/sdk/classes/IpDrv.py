...
class UClientBeaconAddressResolver_Data(Structure):
    _fields_ = [("BeaconPort", c_int), ("BeaconName", FName)]
...
class UMCPBase_Data(Structure):
    _fields_ = [("VfTable_FTickableObject", FPointer)]


class UMCPBase(Structure):
    _fields_ = [("UObject", UObject_Data), ("UMCPBase", UMCPBase_Data)]
...
class UMeshBeacon(Structure):
    _fields_ = [("UObject", UObject_Data), ("UMeshBeacon", UMeshBeacon_Data)]
...
class UPartyBeacon(Structure):
    _fields_ = [("UObject", UObject_Data), ("UPartyBeacon", UPartyBeacon_Data)]
...
class UTcpipConnection_Data(Structure):
    _fields_ = [("Unknown1", c_ubyte, 0x20)]
...
class UWebRequest(Structure):
    _fields_ = [("UObject", UObject_Data), ("UWebRequest", UWebRequest_Data)]
...
class UWebResponse(Structure):
    _fields_ = [("UObject", UObject_Data), ("UWebResponse", UWebResponse_Data)]
...
class UWebApplication(Structure):
    _fields_ = [("UObject", UObject_Data), ("UWebApplication", UWebApplication_Data)]
