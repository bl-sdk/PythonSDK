...
class  UInterpTrackAkEvent_Data(Structure):
	_fields_ = [
		("AkEvents", TArray_FAkEventTrackKey),
	]
...
BL2SDK.g_loadedClasses += [("UAkAmbientSoundRenderingComponent", 3529, "UPrimitiveComponent")]
...
BL2SDK.g_loadedClasses += [("UWwiseSoundGroupRenderingComponent", 3561, "UPrimitiveComponent")]
