...
class TArray_UBehavior_SpawnProjectile_FProjectileBehaviorSequenceStateData(Structure):
	_fields_ = [
		("Data", POINTER(UBehavior_SpawnProjectile_FProjectileBehaviorSequenceStateData)),
		("Count", int),
		("Max", int),
	]
...
class TArray_UBehavior_SpawnProjectileFromImpact_FProjectileBehaviorSequenceStateData(Structure):
	_fields_ = [
...
class TArray_FNameEntryPtr(Structure):
	_fields_ = [
		POINTER(POINTER(FNameEntry)) Data;
		("Count", int),
		("Max", int),
	]
