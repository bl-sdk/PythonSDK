...
class  FStaticMeshLODInfo(Structure):
	_fields_ = [
		("Elements", TArray_FStaticMeshLODElement),
	]
...
class  FInstanceDataSet(Structure):
	_fields_ = [
		("Data", TArray_FInstanceDataUnion),
	]
...
class  FGestaltLODModel(Structure):
	_fields_ = [
		("GestaltFragments", TArray_FGestaltLODModelFragment),
	]
...
class  FKCachedConvexData_Mirror(Structure):
	_fields_ = [
		("CachedConvexElements", TArray_int),
	]
...
class  FBehaviorParameters(Structure):
	_fields_ = [
		("Parameters", TArray_FBehaviorParameterUnion),
	]
...
class  FCounterBehaviorUserState(Structure):
	_fields_ = [
		("Counters", FBehaviorCounterState * 2),
	]
...
class  FPostProcessMaterialRef(Structure):
	_fields_ = [
		("Effect", POINTER(UMaterialEffect)),
	]
...
class  FPhysXVerticalProperties(Structure):
	_fields_ = [
		("Emitters", FPhysXEmitterVerticalProperties),
	]
...
class  FSplitscreenData(Structure):
	_fields_ = [
		("PlayerData", TArray_FPerPlayerSplitscreenData),
	]
...
class  FGBXNavMeshLookupCell(Structure):
	_fields_ = [
		("IntersectingPolys", FArray_Mirror),
	]
...
class  FGPMCollection(Structure):
	_fields_ = [
		("CollectionData", POINTER(UGestaltPartMatrices)),
	]
...
class  FInterpLookupTrack(Structure):
	_fields_ = [
		("Points", TArray_FInterpLookupPoint),
	]
...
class  FLODSoloTrack(Structure):
	_fields_ = [
		("SoloEnableSetting", TArray_unsigned_char),
	]
...
class  FKCachedConvexDataElement(Structure):
	_fields_ = [
		("ConvexElementData", TArray_unsigned_char),
	]
...
class  FCachedTerrainMaterialArray(Structure):
	_fields_ = [
		("CachedMaterials", TArray_FPointer),
	]
