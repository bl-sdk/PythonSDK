...
BL2SDK.g_classFuncs["UMeshBeaconClient"]["OnCreateNewSessionRequestReceived"] = {
    "fields": [
        ...
        },
        {
            ...
            "index": 45307,
            "isOutParm": True,
            "cType": TArray_FPlayerMember,
            "castTo": POINTER(TArray_FPlayerMember),
            "TArray": True,
            "offset": 12,
        },
    ],
...
BL2SDK.g_classFuncs["UMeshBeaconClient"]["OnReceivedBandwidthTestResults"] = {
    "fields": [
        ...
        },
        {
            ...
            "index": 45300,
            "isOutParm": True,
            "cType": FConnectionBandwidthStats,
            "castTo": POINTER(FConnectionBandwidthStats),
            "offset": 4,
        },
    ],
    "dataSize": 16,
...
BL2SDK.g_classFuncs["UMeshBeaconClient"]["RequestConnection"] = {
    "fields": [
        ...
        },
        {
            ...
            "index": 45292,
            "isOutParm": True,
            "cType": FClientConnectionRequest,
            "castTo": POINTER(FClientConnectionRequest),
            "offset": 8,
        },
        {
    ...
    "fields": [
        {
            ...
            "index": 45370,
            "isOutParm": True,
            "cType": FClientMeshBeaconConnection,
            "castTo": POINTER(FClientMeshBeaconConnection),
            "offset": 0,
        }
    ],
    "dataSize": 104,
    ...
    "fields": [
        {
            ...
            "isRet": True,
            "index": 45727,
            "cType": TArray_FOnlineArbitrationRegistrant,
            "castTo": POINTER(TArray_FOnlineArbitrationRegistrant),
            "TArray": True,
            "offset": 8,
        },
        {
    ...
    "fields": [
        {
            ...
            "isRet": True,
            "index": 45600,
            "castTo": POINTER(POINTER(UOnlineGameSearch)),
            "offset": 0,
        }
    ],
    "dataSize": 4,
...
BL2SDK.g_classFuncs["UPartyBeaconClient"]["RequestReservationUpdate"] = {
    "fields": [
        ...
        },
        {
            ...
            "index": 46105,
            "isOutParm": True,
            "cType": TArray_FPlayerReservation,
            "castTo": POINTER(TArray_FPlayerReservation),
            "TArray": True,
            "offset": 32,
        },
    ],
    ...
    "fields": [
        {
            ...
            "isRet": True,
            "index": 46287,
            "castTo": POINTER(POINTER(UOnlinePlaylistProvider)),
            "offset": 16,
        },
        {
            "name": "ProviderTag",
...
BL2SDK.g_classFuncs["UUIDataStore_OnlinePlaylists"]["GetPlaylistProvider"] = {
    "fields": [
        ...
        },
        {
            ...
            "index": 46282,
            "isOutParm": True,
            "castTo": POINTER(POINTER(UUIResourceDataProvider)),
            "offset": 12,
        },
    ],
    "dataSize": 20,
...
BL2SDK.g_classFuncs["UUIDataStore_OnlinePlaylists"]["FindProviderIndexByFieldValue"] = {
    "fields": [
        ...
        },
        {
            ...
            "index": 46277,
            "isOutParm": True,
            "cType": FUIProviderScriptFieldValue,
            "castTo": POINTER(FUIProviderScriptFieldValue),
            "offset": 16,
        },
    ],
    "dataSize": 120,
...
BL2SDK.g_classFuncs["UUIDataStore_OnlinePlaylists"]["GetResourceProviders"] = {
    "fields": [
        ...
        },
        {
            ...
            "index": 46261,
            "isOutParm": True,
            "cType": TArray_UUIResourceDataProviderPtr,
            "castTo": POINTER(TArray_UUIResourceDataProviderPtr),
            "TArray": True,
            "offset": 8,
        },
    ],
    ...
    "fields": [
        {
            ...
            "isRet": True,
            "index": 46320,
            "castTo": POINTER(POINTER(UWebApplication)),
            "offset": 24,
        },
        {
            "name": "URI",
