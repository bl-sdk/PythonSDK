...
void Export_pystes_IpDrv_classes(py::module &m)
{
	...
	py::class_< AInternetLink, AInfo >(m, "AInternetLink")
		...
		.def("ResolveFailed", &AInternetLink::ResolveFailed)
		.def("Resolved", &AInternetLink::Resolved)
		...
		.def("ParseURL", [](AInternetLink &self , const struct FString& URL, struct FString* Addr, struct FString* LevelName, struct FString* EntryName) { int* pyPortNum = (int*)malloc(sizeof(int)) ;  bool ret =  self.ParseURL(URL, Addr, pyPortNum, LevelName, EntryName); return py::make_tuple(ret, *pyPortNum); })
		;
	py::class_< ATcpLink, AInternetLink >(m, "ATcpLink")
		...
		.def("ReceivedBinary", &ATcpLink::ReceivedBinary)
		.def("ReceivedLine", &ATcpLink::ReceivedLine)
		.def("ReceivedText", &ATcpLink::ReceivedText)
		.def("Closed", &ATcpLink::Closed)
		.def("Opened", &ATcpLink::Opened)
		.def("Accepted", &ATcpLink::Accepted)
	...
	py::class_< UMeshBeacon, UObject >(m, "UMeshBeacon")
		...
		.def("DestroyBeacon", &UMeshBeacon::DestroyBeacon)
		;
	py::class_< UMeshBeaconClient, UMeshBeacon >(m, "UMeshBeaconClient")
		...
		.def("DestroyBeacon", &UMeshBeaconClient::DestroyBeacon)
		.def("SendHostNewGameSessionResponse", [](UMeshBeaconClient &self , bool bSuccess, const struct FName& SessionName, class UClass* SearchClass) { unsigned char* pyPlatformSpecificInfo = (unsigned char*)malloc(sizeof(unsigned char)) ;  bool ret =  self.SendHostNewGameSessionResponse(bSuccess, SessionName, SearchClass, pyPlatformSpecificInfo); return py::make_tuple(ret, *pyPlatformSpecificInfo); })
		.def("OnTravelRequestReceived", [](UMeshBeaconClient &self , const struct FName& SessionName, class UClass* SearchClass) { unsigned char* pyPlatformSpecificInfo = (unsigned char*)malloc(sizeof(unsigned char)) ;   self.OnTravelRequestReceived(SessionName, SearchClass, pyPlatformSpecificInfo); return py::make_tuple(*pyPlatformSpecificInfo); })
		;
	py::class_< UMeshBeaconHost, UMeshBeacon >(m, "UMeshBeaconHost")
		...
		.def("DestroyBeacon", &UMeshBeaconHost::DestroyBeacon)
		.def("InitHostBeacon", &UMeshBeaconHost::InitHostBeacon)
		.def("OnReceivedClientCreateNewSessionResult", [](UMeshBeaconHost &self , bool bSucceeded, const struct FName& SessionName, class UClass* SearchClass) { unsigned char* pyPlatformSpecificInfo = (unsigned char*)malloc(sizeof(unsigned char)) ;   self.OnReceivedClientCreateNewSessionResult(bSucceeded, SessionName, SearchClass, pyPlatformSpecificInfo); return py::make_tuple(*pyPlatformSpecificInfo); })
		.def("TellClientsToTravel", [](UMeshBeaconHost &self , const struct FName& SessionName, class UClass* SearchClass) { unsigned char* pyPlatformSpecificInfo = (unsigned char*)malloc(sizeof(unsigned char)) ;   self.TellClientsToTravel(SessionName, SearchClass, pyPlatformSpecificInfo); return py::make_tuple(*pyPlatformSpecificInfo); })
		;
	py::class_< UOnlineSubsystemCommonImpl, UOnlineSubsystem >(m, "UOnlineSubsystemCommonImpl")
		...
		.def("GetPlayerNicknameFromIndex", &UOnlineSubsystemCommonImpl::GetPlayerNicknameFromIndex, py::return_value_policy::reference)
		;
	...
	py::class_< UOnlineGameInterfaceImpl, UObject >(m, "UOnlineGameInterfaceImpl")
		...
		.def("ReadPlatformSpecificSessionInfoBySessionName", [](UOnlineGameInterfaceImpl &self , const struct FName& SessionName) { unsigned char* pyPlatformSpecificInfo = (unsigned char*)malloc(sizeof(unsigned char)) ;  bool ret =  self.ReadPlatformSpecificSessionInfoBySessionName(SessionName, pyPlatformSpecificInfo); return py::make_tuple(ret, *pyPlatformSpecificInfo); })
	...
	py::class_< UOnlinePlaylistManager, UObject >(m, "UOnlinePlaylistManager")
		...
		.def("SendPlaylistPopulationUpdate", &UOnlinePlaylistManager::SendPlaylistPopulationUpdate)
	...
	py::class_< UPartyBeacon, UObject >(m, "UPartyBeacon")
		...
		.def("DestroyBeacon", &UPartyBeacon::DestroyBeacon)
		;
	py::class_< UPartyBeaconClient, UPartyBeacon >(m, "UPartyBeaconClient")
		...
		.def("DestroyBeacon", &UPartyBeaconClient::DestroyBeacon)
	...
	py::class_< UPartyBeaconHost, UPartyBeacon >(m, "UPartyBeaconHost")
		...
		.def("UnregisterParty", &UPartyBeaconHost::UnregisterParty)
		.def("UnregisterPartyMembers", &UPartyBeaconHost::UnregisterPartyMembers)
		.def("RegisterPartyMembers", &UPartyBeaconHost::RegisterPartyMembers)
		...
		.def("DestroyBeacon", &UPartyBeaconHost::DestroyBeacon)
	...
	py::class_< UWebResponse, UObject >(m, "UWebResponse")
		...
		.def("SendBinary", &UWebResponse::SendBinary)
		.def("SendText", &UWebResponse::SendText)
	...
	py::class_< UUIDataStore_OnlinePlaylists, UUIDataStore >(m, "UUIDataStore_OnlinePlaylists")
		...
		.def("GetMatchTypeForPlaylistId", &UUIDataStore_OnlinePlaylists::GetMatchTypeForPlaylistId)
		...
		.def("Init", &UUIDataStore_OnlinePlaylists::Init)
		.def_static("GetOnlinePlaylistProvider", [](const struct FName& ProviderTag, int PlaylistId) { int* pyProviderIndex = (int*)malloc(sizeof(int)) ;  static class UOnlinePlaylistProvider* ret = UUIDataStore_OnlinePlaylists::GetOnlinePlaylistProvider(ProviderTag, PlaylistId, pyProviderIndex); return py::make_tuple(ret, *pyProviderIndex); })
		.def("GetPlaylistProvider", [](UUIDataStore_OnlinePlaylists &self , const struct FName& ProviderTag, int ProviderIndex) { class UUIResourceDataProvider** pyout_Provider = 0 ;  bool ret =  self.GetPlaylistProvider(ProviderTag, ProviderIndex, pyout_Provider); return py::make_tuple(ret, *pyout_Provider); })
		;
	...
	py::class_< AWebServer, ATcpLink >(m, "AWebServer")
		...
		.def("LostChild", &AWebServer::LostChild)
		.def("GainedChild", &AWebServer::GainedChild)
		.def("Destroyed", &AWebServer::Destroyed)
	...
	py::class_< AWebConnection, ATcpLink >(m, "AWebConnection")
		...
		.def("ReceivedText", &AWebConnection::ReceivedText)
		.def("Timer", &AWebConnection::Timer)
		.def("Closed", &AWebConnection::Closed)
		.def("Accepted", &AWebConnection::Accepted)
		;
