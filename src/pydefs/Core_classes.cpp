...
void Export_pystes_Core_classes(py::module &m)
{
	py::class_< UObject >(m, "UObject")
		...
		.def("GetStructProperty", &UObject::GetStructProperty, py::return_value_policy::reference)
		.def("GetStrProperty", &UObject::GetStrProperty, py::return_value_policy::reference)
		.def("GetObjectProperty", &UObject::GetObjectProperty, py::return_value_policy::reference)
		.def("GetComponentProperty", &UObject::GetComponentProperty, py::return_value_policy::reference)
		.def("GetClassProperty", &UObject::GetClassProperty, py::return_value_policy::reference)
		.def("GetNameProperty", &UObject::GetNameProperty, py::return_value_policy::reference)
		.def("GetIntProperty", &UObject::GetIntProperty)
		.def("GetInterfaceProperty", &UObject::GetInterfaceProperty, py::return_value_policy::reference)
		.def("GetFloatProperty", &UObject::GetFloatProperty)
		.def("GetDelegateProperty", &UObject::GetDelegateProperty, py::return_value_policy::reference)
		.def("GetByteProperty", &UObject::GetByteProperty)
		.def("GetBoolProperty", &UObject::GetBoolProperty)
	...
	py::class_< UStruct, UField >(m, "UStruct")
		...
		.def_readwrite("PropertyLink", &UStruct::PropertyLink, py::return_value_policy::reference)
