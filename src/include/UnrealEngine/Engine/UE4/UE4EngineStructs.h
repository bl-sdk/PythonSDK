...
struct FGbxSpawnActorAsyncRequest
{
	...
	bool                                               bSkipOnClients;                                           // 0x0098(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0099(0x0003) MISSED OFFSET
...
{
	unsigned char                                      UnknownData00[0x6B0];                                     // 0x0000(0x06B0) MISSED OFFSET
};
...
struct FAnimNode_StateMachine : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData01[0x130];                                     // 0x0050(0x0130) MISSED OFFSET
};
...
// 0x0190 (0x0840 - 0x06B0)
struct FAnimSingleNodeInstanceProxy : public FAnimInstanceProxy
{
	unsigned char                                      UnknownData00[0x190];                                     // 0x06B0(0x0190) MISSED OFFSET
};
