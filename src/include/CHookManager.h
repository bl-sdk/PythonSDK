...
public:
	...
	void Register(const std::string& FuncName, const std::string& HookName, const std::function<bool(UObject*, UFunction*, FStruct*)>
	              & FuncHook);
	...
	bool ProcessHooks(UObject* Caller, FFrame& Stack, void* const Result, UFunction* Function);
