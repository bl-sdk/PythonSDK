...
table.insert(g_loadedClasses, { "UGameWaveForms", 38391, "UObject" })
table.insert(g_loadedClasses, { "APlayerCollectorGame", 38588, "AGameInfo" })
table.insert(g_loadedClasses, { "UPMESTG_LeaveADecalBase", 38602, "UParticleModuleEventSendToGame" })
