...
table.insert(g_loadedClasses, { "UAction_ChangeRuleSet", 38895, "UActionSequence" })
table.insert(g_loadedClasses, { "URES_RuleSetChange", 38899, "UActionResource" })
table.insert(g_loadedClasses, { "UAction_FaceThreat", 38902, "UActionSequencePawn" })
table.insert(g_loadedClasses, { "URES_FacingPolicy", 38909, "UActionResource" })
table.insert(g_loadedClasses, { "UAction_MoveRandom", 38910, "UActionSequencePawn" })
table.insert(g_loadedClasses, { "UAction_MoveTo", 38912, "UActionSequencePawn" })
table.insert(g_loadedClasses, { "URES_Movement", 39140, "UActionResource" })
table.insert(g_loadedClasses, { "UAction_PopRuleSet", 39141, "UActionSequencePawn" })
table.insert(g_loadedClasses, { "UAction_PushRuleSet", 39144, "UActionSequencePawn" })
table.insert(g_loadedClasses, { "UActorAttributeContextResolver", 39162, "UAttributeContextResolver" })
table.insert(g_loadedClasses, { "UAIComponentAttributeContextResolver", 39278, "UAttributeContextResolver" })
table.insert(g_loadedClasses, { "UAIStateBase", 39597, "UGearboxEditorNode" })
table.insert(g_loadedClasses, { "UAIState", 39599, "UAIStateBase" })
table.insert(g_loadedClasses, { "UAIState_Priority", 39601, "UAIStateBase" })
table.insert(g_loadedClasses, { "UAIState_Random", 39603, "UAIStateBase" })
table.insert(g_loadedClasses, { "UAIState_Sequential", 39605, "UAIStateBase" })
table.insert(g_loadedClasses, { "UBehavior_AIHold", 39694, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_AIPriority", 39709, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_AITargeting", 39723, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_ChangeAnyBehaviorSequenceState", 39746, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_ChangeLocalBehaviorSequenceState", 39762, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_CompareBool", 39830, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_CompareValues", 39842, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_CustomEvent", 39855, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_Delay", 39869, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_Gate", 39879, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_GetFloatParam", 39891, "UParameterBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_GetObjectParam", 39905, "UParameterBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_GetVectorParam", 39919, "UParameterBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_InterpolateFloatOverTime", 39938, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_Metronome", 39969, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_ModifyTimer", 39984, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_SetFloatParam", 40110, "UParameterBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_SetObjectParam", 40121, "UParameterBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_SetVectorParam", 40132, "UParameterBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_SpecialMove", 40153, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_SpecialMoveStop", 40187, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_StartAkAmbientSound", 40201, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_StopAkAmbientSound", 40215, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_StopDialog", 40229, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UBehavior_ToggleDialog", 40243, "UBehaviorBase" })
table.insert(g_loadedClasses, { "UCameraModifierCrossfade", 40602, "UGearboxCameraModifier" })
table.insert(g_loadedClasses, { "UCameraModifierLookAt", 40644, "UGearboxCameraModifier" })
table.insert(g_loadedClasses, { "UDefinitionUITestCaseDefinition", 40758, "UGBXDefinition" })
table.insert(g_loadedClasses, { "USparkNews", 41097, "UObject" })
table.insert(g_loadedClasses, { "UGearboxAccountEntitlement", 41281, "UObject" })
table.insert(g_loadedClasses, { "UGearboxAccountOffer", 41298, "UObject" })
table.insert(g_loadedClasses, { "APatrolDestination", 41561, "AActor" })
table.insert(g_loadedClasses, { "UGearboxSeqAct_TargetPriority", 42592, "USequenceAction" })
table.insert(g_loadedClasses, { "UGearboxSeqAct_CameraShake", 43108, "USequenceAction" })
table.insert(g_loadedClasses, { "UGearboxSeqAct_PawnClonerLink", 43421, "USeqAct_Latent" })
table.insert(g_loadedClasses, { "UGFxMovieDrawStyleInstanceData", 43594, "UGFxMovieDrawStyleRTT" })
table.insert(g_loadedClasses, { "USeqEvent_AllSpawned", 43898, "USequenceEvent" })
table.insert(g_loadedClasses, { "UPopulationMasterAttributeContextResolver", 44207, "UAttributeContextResolver" })
table.insert(g_loadedClasses, { "USeqEvent_SinglePopulationDeath", 44385, "USequenceEvent" })
table.insert(g_loadedClasses, { "URES_Rotation", 44538, "UActionResource" })
table.insert(g_loadedClasses, { "URES_SpecialMove", 44541, "UActionResource" })
table.insert(g_loadedClasses, { "USeqEvent_ArrivedAtMoveNode", 44619, "USequenceEvent" })
table.insert(g_loadedClasses, { "USeqEvent_LeavingMoveNode", 44624, "USequenceEvent" })
table.insert(g_loadedClasses, { "UShowDebugHelpers", 44641, "UObject" })
table.insert(g_loadedClasses, { "ASkeletalMeshActorGBXMatinee", 44655, "ASkeletalMeshActor" })
table.insert(g_loadedClasses, { "UGearboxEULAGFxMovie", 45051, "UGearboxGFxMovie" })
table.insert(g_loadedClasses, { "UGearboxEULAGFxObject", 45059, "UGFxObject" })
