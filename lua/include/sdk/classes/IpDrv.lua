...
table.insert(g_loadedClasses, { "UWebApplication", 45133, "UObject" })
table.insert(g_loadedClasses, { "AWebServer", 45136, "ATcpLink" })
table.insert(g_loadedClasses, { "UHelloWeb", 45152, "UWebApplication" })
table.insert(g_loadedClasses, { "UImageServer", 45170, "UWebApplication" })
table.insert(g_loadedClasses, { "AWebConnection", 46294, "ATcpLink" })
