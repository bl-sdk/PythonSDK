...
for _,pkg in ipairs(packages) do
	...
	include("include/sdkgen/consts/" .. pkg .. ".lua")
	include("include/sdkgen/enums/" .. pkg .. ".lua")
	include("include/sdkgen/structs/" .. pkg .. ".lua")
	include("include/sdkgen/classes/" .. pkg .. ".lua")
	include("include/sdkgen/funcs/" .. pkg .. ".lua")
...
local function CreateDirectoryStructure()
	local dirs = {
		[[include/sdkgen]],
		[[include/sdkgen/classes]],
		[[include/sdkgen/consts]],
		[[include/sdkgen/enums]],
		[[include/sdkgen/funcs]],
		[[include/sdkgen/structs]]
	}
