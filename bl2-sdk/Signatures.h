...
namespace BL2SDK
{
	namespace Signatures
	{
		...
		MemorySignature PreFName = {
			"\x55\x8B\xEC\x8B\x45\x08\x53\x56\x8B\x75\x14\x57\x85\xF6\x74\x0E",
			"xxxxxxxxxxxxxxxx",
			16
		};

		MemorySignature CreateFName = {
			"",
			"xxxxxxxx?xxxxxxxxxxxxxxxxx?xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
			64
		};
	}
}
