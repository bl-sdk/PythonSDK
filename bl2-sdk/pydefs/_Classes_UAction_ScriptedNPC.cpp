...
{
    py::class_< UAction_ScriptedNPC,  UWillowActionSequencePawn   >(m, "UAction_ScriptedNPC")
		.def_static("StaticClass", &UAction_ScriptedNPC::StaticClass, py::return_value_policy::reference)
