...
void Export_pystes_UWillowGameViewportClient()
{
    py::class_< UWillowGameViewportClient,  UGameViewportClient   >("UWillowGameViewportClient")
        ...
        .def_readonly("LevelActionMessages", &UWillowGameViewportClient::LevelActionMessages)
        .def_readonly("SavedLoginState", &UWillowGameViewportClient::SavedLoginState)
        .def_readonly("CurrentLoginState", &UWillowGameViewportClient::CurrentLoginState)
        .def_readonly("Gamepads", &UWillowGameViewportClient::Gamepads)
        .def_readonly("WaitingOnDeviceSelectionResults", &UWillowGameViewportClient::WaitingOnDeviceSelectionResults)
