...
{
    class_< URuleEngine, bases< UObject >  , boost::noncopyable>("URuleEngine", no_init)
        ...
        .def("StaticClass", &URuleEngine::StaticClass, return_value_policy< reference_existing_object >())
        .def("ApplyFlagInitializationData", &URuleEngine::ApplyFlagInitializationData)
        .def("IsResourceInUse", &URuleEngine::IsResourceInUse)
        .def("GetContextSource", &URuleEngine::GetContextSource, return_value_policy< reference_existing_object >())
