...
{
    py::class_< UNavMeshPath_WithinTraversalDist,  UNavMeshPathConstraint   >("UNavMeshPath_WithinTraversalDist")
        ...
        .def("StaticClass", &UNavMeshPath_WithinTraversalDist::StaticClass, py::return_value_policy::reference)
