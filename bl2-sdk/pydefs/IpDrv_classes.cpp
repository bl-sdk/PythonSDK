...
{
	py::class_< UClientBeaconAddressResolver, UAudioDevice >(m, "UClientBeaconAddressResolver")
		...
		;
	py::class_< UHTTPDownload, UAudioDevice >(m, "UHTTPDownload")
		...
		.def_readwrite("UnknownData00[0xEC]", &UHTTPDownload::UnknownData00[0xEC])
		;
	py::class_< AInternetLink, UAudioDevice >(m, "AInternetLink")
		...
		;
	py::class_< ATcpLink, UAudioDevice >(m, "ATcpLink")
		...
		;
	py::class_< UMCPBase, UAudioDevice >(m, "UMCPBase")
		...
		;
	py::class_< UOnlineEventsInterfaceMcp, UAudioDevice >(m, "UOnlineEventsInterfaceMcp")
		...
		;
	py::class_< UOnlineNewsInterfaceMcp, UAudioDevice >(m, "UOnlineNewsInterfaceMcp")
		...
		;
	py::class_< UOnlineTitleFileDownloadMcp, UAudioDevice >(m, "UOnlineTitleFileDownloadMcp")
		...
		;
	py::class_< UMeshBeacon, UAudioDevice >(m, "UMeshBeacon")
		...
		;
	py::class_< UMeshBeaconClient, UAudioDevice >(m, "UMeshBeaconClient")
		...
		;
	py::class_< UMeshBeaconHost, UAudioDevice >(m, "UMeshBeaconHost")
		...
		;
	py::class_< UOnlineSubsystemCommonImpl, UAudioDevice >(m, "UOnlineSubsystemCommonImpl")
		...
		;
	py::class_< UOnlineAuthInterfaceImpl, UAudioDevice >(m, "UOnlineAuthInterfaceImpl")
		...
		;
	py::class_< UOnlineGameInterfaceImpl, UAudioDevice >(m, "UOnlineGameInterfaceImpl")
		...
		.def_readwrite("LanNonce[0x8]", &UOnlineGameInterfaceImpl::LanNonce[0x8])
		...
		;
	py::class_< UOnlinePlaylistManager, UAudioDevice >(m, "UOnlinePlaylistManager")
		...
		.def_readwrite("UnknownData00[0x4]", &UOnlinePlaylistManager::UnknownData00[0x4])
		...
		;
	py::class_< UPartyBeacon, UAudioDevice >(m, "UPartyBeacon")
		...
		;
	py::class_< UPartyBeaconClient, UAudioDevice >(m, "UPartyBeaconClient")
		...
		;
	py::class_< UPartyBeaconHost, UAudioDevice >(m, "UPartyBeaconHost")
		...
		;
	py::class_< UTcpipConnection, UAudioDevice >(m, "UTcpipConnection")
		.def_static("StaticClass", &UTcpipConnection::StaticClass, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x20]", &UTcpipConnection::UnknownData00[0x20])
		;
	py::class_< UTcpNetDriver, UAudioDevice >(m, "UTcpNetDriver")
		...
		.def_readwrite("UnknownData00[0x18]", &UTcpNetDriver::UnknownData00[0x18])
		;
	py::class_< UWebRequest, UAudioDevice >(m, "UWebRequest")
		...
		;
	py::class_< UWebResponse, UAudioDevice >(m, "UWebResponse")
		...
		;
	py::class_< UOnlinePlaylistProvider, UAudioDevice >(m, "UOnlinePlaylistProvider")
		...
		;
	py::class_< UUIDataStore_OnlinePlaylists, UAudioDevice >(m, "UUIDataStore_OnlinePlaylists")
		...
		;
	py::class_< UWebApplication, UAudioDevice >(m, "UWebApplication")
		...
		;
	py::class_< AWebServer, UAudioDevice >(m, "AWebServer")
		...
		.def_readwrite("Applications[0xA]", &AWebServer::Applications[0xA], py::return_value_policy::reference)
		.def_readwrite("ApplicationPaths[0xA]", &AWebServer::ApplicationPaths[0xA], py::return_value_policy::reference)
		...
		.def_readwrite("ApplicationObjects[0xA]", &AWebServer::ApplicationObjects[0xA], py::return_value_policy::reference)
		...
		;
	py::class_< UHelloWeb, UAudioDevice >(m, "UHelloWeb")
