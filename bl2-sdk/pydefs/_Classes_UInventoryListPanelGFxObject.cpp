...
{
    class_< UInventoryListPanelGFxObject, bases< UGFxObject >  , boost::noncopyable>("UInventoryListPanelGFxObject", no_init)
        ...
        .def("StaticClass", &UInventoryListPanelGFxObject::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetCellObject", &UInventoryListPanelGFxObject::GetCellObject, return_value_policy< reference_existing_object >())
        ...
        .def("GetThingByIndex", &UInventoryListPanelGFxObject::GetThingByIndex, return_value_policy< reference_existing_object >())
        .def("GetSelectedThing", &UInventoryListPanelGFxObject::GetSelectedThing, return_value_policy< reference_existing_object >())
