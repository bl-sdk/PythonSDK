...
void Export_pystes_WillowGame_structs(py::module &m)
{
	...
	py::class_< FTurnData >(m, "FTurnData")
		...
		.def_readwrite("Left", &FTurnData::Left, py::return_value_policy::reference)
		.def_readwrite("Right", &FTurnData::Right, py::return_value_policy::reference)
		.def_readwrite("Left01", &FTurnData::Left01, py::return_value_policy::reference)
		.def_readwrite("Right01", &FTurnData::Right01, py::return_value_policy::reference)
		.def_readwrite("Left02", &FTurnData::Left02, py::return_value_policy::reference)
		.def_readwrite("Right02", &FTurnData::Right02, py::return_value_policy::reference)
		;
	...
	py::class_< FBeamDamageData >(m, "FBeamDamageData")
		...
		.def_readwrite("DamageCauser", &FBeamDamageData::DamageCauser, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FBeamDamageData::UnknownData00[0x4])
		;
	...
	py::class_< FBeamLocationData >(m, "FBeamLocationData")
		...
		.def_readwrite("WorldBody", &FBeamLocationData::WorldBody, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FBeamLocationData::UnknownData00[0x4])
		;
	...
	py::class_< FPendingMissionRewardData >(m, "FPendingMissionRewardData")
		...
		.def_readwrite("WeaponRewards[0x2]", &FPendingMissionRewardData::WeaponRewards[0x2], py::return_value_policy::reference)
		.def_readwrite("ItemRewards[0x2]", &FPendingMissionRewardData::ItemRewards[0x2], py::return_value_policy::reference)
		;
	py::class_< FUnloadableDlcPendingRewardData >(m, "FUnloadableDlcPendingRewardData")
		...
		.def_readwrite("WeaponRewards[0x2]", &FUnloadableDlcPendingRewardData::WeaponRewards[0x2], py::return_value_policy::reference)
		.def_readwrite("ItemRewards[0x2]", &FUnloadableDlcPendingRewardData::ItemRewards[0x2], py::return_value_policy::reference)
	...
	py::class_< FSKURuntimeLibrarySet >(m, "FSKURuntimeLibrarySet")
		...
		.def_readwrite("Libraries[0x6]", &FSKURuntimeLibrarySet::Libraries[0x6], py::return_value_policy::reference)
		;
	...
	py::class_< FReplicatedMissionData >(m, "FReplicatedMissionData")
		...
		.def_readwrite("SubObjectiveSets[0x4]", &FReplicatedMissionData::SubObjectiveSets[0x4], py::return_value_policy::reference)
		.def_readwrite("SecondsLeft", &FReplicatedMissionData::SecondsLeft)
		.def_readwrite("ObjectiveCounts[0x14]", &FReplicatedMissionData::ObjectiveCounts[0x14])
	...
	py::class_< FReplicatedMissionDirectiveData >(m, "FReplicatedMissionDirectiveData")
		.def_readwrite("MissionDirector", &FReplicatedMissionDirectiveData::MissionDirector, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FReplicatedMissionDirectiveData::UnknownData00[0x4])
	...
	py::class_< FPlayerSaveData >(m, "FPlayerSaveData")
		...
		.def_readwrite("CurrencyOnHand[0xD]", &FPlayerSaveData::CurrencyOnHand[0xD])
	...
	py::class_< FActiveStatusEffect >(m, "FActiveStatusEffect")
		...
		.def_readwrite("DamageCauser", &FActiveStatusEffect::DamageCauser, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FActiveStatusEffect::UnknownData00[0x4])
	...
	py::class_< FObstacleData >(m, "FObstacleData")
		...
		.def_readwrite("IDO", &FObstacleData::IDO, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FObstacleData::UnknownData00[0x4])
		;
	...
	py::class_< FChosenVehicleCustomization >(m, "FChosenVehicleCustomization")
		...
		.def_readwrite("CustomizationDef[0x2]", &FChosenVehicleCustomization::CustomizationDef[0x2], py::return_value_policy::reference)
		;
	...
	py::class_< FRemoveObject >(m, "FRemoveObject")
		.def_readwrite("Name", &FRemoveObject::Name, py::return_value_policy::reference)
		;
	...
	py::class_< FSourceObjectData >(m, "FSourceObjectData")
		...
		.def_readwrite("DamageContext", &FSourceObjectData::DamageContext, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FSourceObjectData::UnknownData00[0x4])
		...
		.def_readwrite("DamageCauser", &FSourceObjectData::DamageCauser, py::return_value_policy::reference)
		.def_readwrite("UnknownData01[0x4]", &FSourceObjectData::UnknownData01[0x4])
	...
	py::class_< FDataProviderInfo >(m, "FDataProviderInfo")
		.def_readwrite("DataProvider", &FDataProviderInfo::DataProvider, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FDataProviderInfo::UnknownData00[0x4])
	...
	py::class_< FMinimapIconHelper_Director >(m, "FMinimapIconHelper_Director")
		...
		.def_readwrite("Director", &FMinimapIconHelper_Director::Director, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FMinimapIconHelper_Director::UnknownData00[0x4])
	...
	py::class_< FDefendMissionData >(m, "FDefendMissionData")
		...
		.def_readwrite("Target", &FDefendMissionData::Target, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FDefendMissionData::UnknownData00[0x4])
		;
	...
	py::class_< FPopulatedInteractiveObjectMemento >(m, "FPopulatedInteractiveObjectMemento")
		...
		.def_readwrite("bCanBeUsed[0x2]", &FPopulatedInteractiveObjectMemento::bCanBeUsed[0x2])
		;
	...
	py::class_< FLockOnProfile >(m, "FLockOnProfile")
		...
		.def_readwrite("Target", &FLockOnProfile::Target, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FLockOnProfile::UnknownData00[0x4])
	...
	py::class_< FViewProfile >(m, "FViewProfile")
		...
		.def_readwrite("UnknownData00[0x4]", &FViewProfile::UnknownData00[0x4])
	...
	py::class_< FHUDInteractionIcon >(m, "FHUDInteractionIcon")
		.def_readwrite("Icons[0x2]", &FHUDInteractionIcon::Icons[0x2], py::return_value_policy::reference)
		;
	...
	py::class_< FVelocityObstacle >(m, "FVelocityObstacle")
		.def_readwrite("Segments[0x3]", &FVelocityObstacle::Segments[0x3], py::return_value_policy::reference)
		;
	...
	py::class_< FWeaponBoneControllerInstance >(m, "FWeaponBoneControllerInstance")
		...
		.def_readwrite("BoneController", &FWeaponBoneControllerInstance::BoneController, py::return_value_policy::reference)
		.def_readwrite("UnknownData00[0x4]", &FWeaponBoneControllerInstance::UnknownData00[0x4])
		;
	...
	py::class_< FItemSettings >(m, "FItemSettings")
		...
		.def_readwrite("GenericParts[0x9]", &FItemSettings::GenericParts[0x9], py::return_value_policy::reference)
	...
	py::class_< FWeaponSettings >(m, "FWeaponSettings")
		...
		.def_readwrite("GenericParts[0x9]", &FWeaponSettings::GenericParts[0x9], py::return_value_policy::reference)
