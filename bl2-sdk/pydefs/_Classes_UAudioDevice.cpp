...
void Export_pystes_UAudioDevice()
{
    py::class_< UAudioDevice,  USubsystem   >("UAudioDevice")
        ...
        .def_readonly("UnknownData00", &UAudioDevice::UnknownData00)
        .def_readwrite("Listeners", &UAudioDevice::Listeners)
        .def_readwrite("CurrentTick", &UAudioDevice::CurrentTick)
        .def_readonly("UnknownData01", &UAudioDevice::UnknownData01)
        .def_readonly("UnknownData02", &UAudioDevice::UnknownData02)
        .def_readonly("UnknownData03", &UAudioDevice::UnknownData03)
        .def_readonly("UnknownData04", &UAudioDevice::UnknownData04)
        .def_readonly("UnknownData05", &UAudioDevice::UnknownData05)
