...
{
    class_< ABehaviorVolume, bases< APhysicsVolume >  , boost::noncopyable>("ABehaviorVolume", no_init)
        ...
        .def("StaticClass", &ABehaviorVolume::StaticClass, return_value_policy< reference_existing_object >())
