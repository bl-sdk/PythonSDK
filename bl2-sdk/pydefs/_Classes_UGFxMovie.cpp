...
{
    class_< UGFxMovie, bases< UObject >  , boost::noncopyable>("UGFxMovie", no_init)
        ...
        .def("StaticClass", &UGFxMovie::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetGFxManager", &UGFxMoviePlayer::GetGFxManager, return_value_policy< reference_existing_object >())
        ...
        .def("GetPC", &UGFxMoviePlayer::GetPC, return_value_policy< reference_existing_object >())
        .def("GetLP", &UGFxMoviePlayer::GetLP, return_value_policy< reference_existing_object >())
        ...
        .def("ActionScriptObject", &UGFxMoviePlayer::ActionScriptObject, return_value_policy< reference_existing_object >())
        ...
        .def("CreateArray", &UGFxMoviePlayer::CreateArray, return_value_policy< reference_existing_object >())
        .def("CreateObject", &UGFxMoviePlayer::CreateObject, return_value_policy< reference_existing_object >())
        ...
        .def("GetVariableObject", &UGFxMoviePlayer::GetVariableObject, return_value_policy< reference_existing_object >())
        ...
        .def("GetGameViewportClient", &UGFxMoviePlayer::GetGameViewportClient, return_value_policy< reference_existing_object >())
