...
void Export_pystes_AWillowVehicle(py::object m)
{
    py::class_< AWillowVehicle,  ASVehicle   >(m, "AWillowVehicle")
        ...
        .def("StaticClass", &AWillowVehicle::StaticClass, py::return_value_policy::reference)
        .def("CrushedByActor", &AWillowVehicle::CrushedByActor)
        .def("GetOccupantWhoCanPickup", &AWillowVehicle::GetOccupantWhoCanPickup, py::return_value_policy::reference)
