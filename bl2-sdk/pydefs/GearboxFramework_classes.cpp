...
void Export_pystes_GearboxFramework_classes(py::module &m)
{
	...
	py::class_< UBehaviorHelpers, UObject >(m, "UBehaviorHelpers")
		...
		.def_static("ResolveBehaviorProviderDefinitionReference", &UBehaviorHelpers::ResolveBehaviorProviderDefinitionReference)
		.def_static("IsBehaviorsV2", &UBehaviorHelpers::IsBehaviorsV2)
		.def_static("GetNextFireLocationSocket", &UBehaviorHelpers::GetNextFireLocationSocket)
		.def_static("GetRotationFromAttachmentLocationData", &UBehaviorHelpers::GetRotationFromAttachmentLocationData)
		.def_static("GetRelativeDirection", &UBehaviorHelpers::GetRelativeDirection)
	...
	py::class_< UGearboxGFxMovie, UGFxMovie >(m, "UGearboxGFxMovie")
		...
		.def_static("GFxColoredText", &UGearboxGFxMovie::GFxColoredText)
	...
	py::class_< UGearboxGlobals, UGearboxEngineGlobals >(m, "UGearboxGlobals")
		...
		.def_static("GetBehaviorKernel", &UGearboxGlobals::GetBehaviorKernel)
		...
		.def_static("GetGearboxGlobals", &UGearboxGlobals::GetGearboxGlobals)
		;
	...
	py::class_< USparkTypes, UObject >(m, "USparkTypes")
		...
		.def_static("UTF8toString", &USparkTypes::UTF8toString)
	...
	py::class_< UFiringBehaviorManager, UObject >(m, "UFiringBehaviorManager")
		...
		.def_static("GetTemplateClass", &UFiringBehaviorManager::GetTemplateClass)
		;
	...
	py::class_< UPopulationMaster, UObject >(m, "UPopulationMaster")
		...
		.def_static("GetStreamingLevelForActor", &UPopulationMaster::GetStreamingLevelForActor)
	...
	py::class_< UBehaviorKernel, UObject >(m, "UBehaviorKernel")
		...
		.def_static("RegisterBehaviorConsumer", &UBehaviorKernel::RegisterBehaviorConsumer)
	...
	py::class_< ULeviathanService, UObject >(m, "ULeviathanService")
		...
		.def_static("GetLeviathanService", &ULeviathanService::GetLeviathanService)
		;
