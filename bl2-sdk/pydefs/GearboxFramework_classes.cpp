...
void Export_pystes_GearboxFramework_classes(py::module &m)
{
	...
	py::class_< UBehaviorHelpers, UObject >(m, "UBehaviorHelpers")
		...
		.def("ShouldContinueExecution", [](UBehaviorHelpers &self , float TimeBetweenSteps, int MaxSteps, struct FBehaviorKernelInfo* KernelInfo) { int* pyNumSteps = (int*)malloc(sizeof(int)) ;  bool ret =  self.ShouldContinueExecution(TimeBetweenSteps, MaxSteps, KernelInfo, pyNumSteps); return py::make_tuple(ret, *pyNumSteps); })
		;
	...
	py::class_< URegionDefinition, UGBXDefinition >(m, "URegionDefinition")
		...
		.def("TestRegionGameStage", [](URegionDefinition &self , unsigned long bDefaultGameStage) { int* pyGameStage = (int*)malloc(sizeof(int)) ; int* pyAwesomeLevel = (int*)malloc(sizeof(int)) ;  bool ret =  self.TestRegionGameStage(bDefaultGameStage, pyGameStage, pyAwesomeLevel); return py::make_tuple(ret, *pyGameStage, *pyAwesomeLevel); })
		.def("GetRegionGameStage", [](URegionDefinition &self , unsigned long bDefaultGameStage) { int* pyGameStage = (int*)malloc(sizeof(int)) ; int* pyAwesomeLevel = (int*)malloc(sizeof(int)) ;  bool ret =  self.GetRegionGameStage(bDefaultGameStage, pyGameStage, pyAwesomeLevel); return py::make_tuple(ret, *pyGameStage, *pyAwesomeLevel); })
		;
