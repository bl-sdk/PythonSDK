...
void Export_pystes_GearboxFramework_classes(py::module &m)
{
	...
	py::class_< USpecialMoveInterface, UInterface >(m, "USpecialMoveInterface")
		...
		.def("ServerSpecialMove_StopAny", &USpecialMoveInterface::ServerSpecialMove_StopAny)
		.def("ServerSpecialMove_Stop", &USpecialMoveInterface::ServerSpecialMove_Stop)
		.def("ServerSpecialMove_Queue", &USpecialMoveInterface::ServerSpecialMove_Queue)
		.def("ServerSpecialMove_Play", &USpecialMoveInterface::ServerSpecialMove_Play)
	...
	py::class_< UBehaviorHelpers, UObject >(m, "UBehaviorHelpers")
		...
		.def_static("RunAllBehaviorsForEvent", &UBehaviorHelpers::RunAllBehaviorsForEvent)
		.def("BehaviorStrategy", &UBehaviorHelpers::BehaviorStrategy)
		.def("BehaviorSetStrategy", &UBehaviorHelpers::BehaviorSetStrategy)
		.def_static("ResolveBehaviorProviderDefinitionReference", &UBehaviorHelpers::ResolveBehaviorProviderDefinitionReference, py::return_value_policy::reference)
		.def_static("IsBehaviorsV2", &UBehaviorHelpers::IsBehaviorsV2)
		.def_static("GetNextFireLocationSocket", &UBehaviorHelpers::GetNextFireLocationSocket, py::return_value_policy::reference)
		.def_static("GetRotationFromAttachmentLocationData", &UBehaviorHelpers::GetRotationFromAttachmentLocationData)
		.def_static("GetRelativeDirection", &UBehaviorHelpers::GetRelativeDirection, py::return_value_policy::reference)
		.def_static("ShouldContinueExecution", [](float TimeBetweenSteps, int MaxSteps, struct FBehaviorKernelInfo* KernelInfo) { int* pyNumSteps = (int*)malloc(sizeof(int)) ;  static bool ret = UBehaviorHelpers::ShouldContinueExecution(TimeBetweenSteps, MaxSteps, KernelInfo, pyNumSteps); return py::make_tuple(ret, *pyNumSteps); })
		;
	...
	py::class_< UGBXActorList, UObject >(m, "UGBXActorList")
		...
		.def("FindNextActorByLevel", [](UGBXActorList &self , class ULevel* Level) { int* pyIndex = (int*)malloc(sizeof(int)) ;  class AActor* ret =  self.FindNextActorByLevel(Level, pyIndex); return py::make_tuple(ret, *pyIndex); })
		.def("FindFirstActorByLevel", [](UGBXActorList &self , class ULevel* Level) { int* pyIndex = (int*)malloc(sizeof(int)) ;  class AActor* ret =  self.FindFirstActorByLevel(Level, pyIndex); return py::make_tuple(ret, *pyIndex); })
		.def("FindNextActorByClass", [](UGBXActorList &self , class UClass* TheClass) { int* pyIndex = (int*)malloc(sizeof(int)) ;  class AActor* ret =  self.FindNextActorByClass(TheClass, pyIndex); return py::make_tuple(ret, *pyIndex); })
		.def("FindFirstActorByClass", [](UGBXActorList &self , class UClass* TheClass) { int* pyIndex = (int*)malloc(sizeof(int)) ;  class AActor* ret =  self.FindFirstActorByClass(TheClass, pyIndex); return py::make_tuple(ret, *pyIndex); })
		;
	py::class_< UGBXObjectList, UObject >(m, "UGBXObjectList")
		...
		.def("FindNextObjectByClass", [](UGBXObjectList &self , class UClass* TheClass) { int* pyIndex = (int*)malloc(sizeof(int)) ;  class UObject* ret =  self.FindNextObjectByClass(TheClass, pyIndex); return py::make_tuple(ret, *pyIndex); })
		.def("FindFirstObjectByClass", [](UGBXObjectList &self , class UClass* TheClass) { int* pyIndex = (int*)malloc(sizeof(int)) ;  class UObject* ret =  self.FindFirstObjectByClass(TheClass, pyIndex); return py::make_tuple(ret, *pyIndex); })
		;
	...
	py::class_< AGearboxCameraBasic, ACamera >(m, "AGearboxCameraBasic")
		...
		.def("FinishCameraLookAt", &AGearboxCameraBasic::FinishCameraLookAt)
		.def("EnableThirdPersonLookAt", &AGearboxCameraBasic::EnableThirdPersonLookAt)
	...
	py::class_< UGearboxDialogInterface, UInterface >(m, "UGearboxDialogInterface")
		...
		.def("ServerDialog_TriggerEvent", &UGearboxDialogInterface::ServerDialog_TriggerEvent)
	...
	py::class_< UGearboxEngine, UGameEngine >(m, "UGearboxEngine")
		...
		.def_static("GetSparkInterface", &UGearboxEngine::GetSparkInterface)
		.def("IsCurrentDeviceValid", &UGearboxEngine::IsCurrentDeviceValid)
	...
	py::class_< UGearboxGFxMovie, UGFxMovie >(m, "UGearboxGFxMovie")
		...
		.def("SetMouseableFlag", &UGearboxGFxMovie::SetMouseableFlag)
		...
		.def("MovieState_OnChanged", &UGearboxGFxMovie::MovieState_OnChanged)
		.def("MovieState_SetFromMovie", &UGearboxGFxMovie::MovieState_SetFromMovie)
		...
		.def_static("MovieState_Apply", &UGearboxGFxMovie::MovieState_Apply)
		.def_static("MovieState_ApplyState", &UGearboxGFxMovie::MovieState_ApplyState)
		...
		.def("PlayUISound", &UGearboxGFxMovie::PlayUISound)
		.def("SetOtherObject", &UGearboxGFxMovie::SetOtherObject)
		.def("GetInstanceContextObject", &UGearboxGFxMovie::GetInstanceContextObject, py::return_value_policy::reference)
		.def("OnTick", &UGearboxGFxMovie::OnTick)
		.def("OnClose", &UGearboxGFxMovie::OnClose)
		.def("Start", &UGearboxGFxMovie::Start)
		.def("ColorizeTooltipText", &UGearboxGFxMovie::ColorizeTooltipText, py::return_value_policy::reference)
		.def_static("GFxColoredText", &UGearboxGFxMovie::GFxColoredText, py::return_value_policy::reference)
	...
	py::class_< UGFxMovie_StateParent, UGearboxGFxMovie >(m, "UGFxMovie_StateParent")
		...
		.def("Start", &UGFxMovie_StateParent::Start)
		;
	py::class_< UGearboxGlobals, UGearboxEngineGlobals >(m, "UGearboxGlobals")
		...
		.def_static("GetBehaviorKernel", &UGearboxGlobals::GetBehaviorKernel, py::return_value_policy::reference)
		...
		.def("ShowDialog", &UGearboxGlobals::ShowDialog)
		...
		.def_static("HasPhysXCapableGPU", &UGearboxGlobals::HasPhysXCapableGPU)
		.def_static("GetPlatform", &UGearboxGlobals::GetPlatform)
		...
		.def_static("GetGearboxGlobals", &UGearboxGlobals::GetGearboxGlobals, py::return_value_policy::reference)
		;
	py::class_< UGearboxGlobalsDefinition, UGBXDefinition >(m, "UGearboxGlobalsDefinition")
		...
		.def_readwrite("EulaMovieDefinition", &UGearboxGlobalsDefinition::EulaMovieDefinition, py::return_value_policy::reference)
		;
	py::class_< UGearboxLocationRequest, UObject >(m, "UGearboxLocationRequest")
		...
		;
	py::class_< UPawnMoveLocationRequest, UGearboxLocationRequest >(m, "UPawnMoveLocationRequest")
	...
	py::class_< AGearboxPawn, AGamePawn >(m, "AGearboxPawn")
		...
		.def("ServerDialog_TriggerEvent", &AGearboxPawn::ServerDialog_TriggerEvent)
		...
		.def("SetCoverState", &AGearboxPawn::SetCoverState)
		.def("GetMountAnimDistanceForSpeed", &AGearboxPawn::GetMountAnimDistanceForSpeed)
		.def("GetSpotOthersShouldLookAt", &AGearboxPawn::GetSpotOthersShouldLookAt, py::return_value_policy::reference)
		.def("SetReplicatedSMData", &AGearboxPawn::SetReplicatedSMData)
		.def("ServerSpecialMove_StopAny", &AGearboxPawn::ServerSpecialMove_StopAny)
		.def("ServerSpecialMove_Stop", &AGearboxPawn::ServerSpecialMove_Stop)
		.def("ServerSpecialMove_Queue", &AGearboxPawn::ServerSpecialMove_Queue)
		.def("ServerSpecialMove_Play", &AGearboxPawn::ServerSpecialMove_Play)
		...
		.def("ReplicatedEvent", &AGearboxPawn::ReplicatedEvent)
		.def("Died", &AGearboxPawn::Died)
		.def("SetMovementPhysics", &AGearboxPawn::SetMovementPhysics)
		.def("PostBeginPlay", &AGearboxPawn::PostBeginPlay)
	...
	py::class_< USparkTypes, UObject >(m, "USparkTypes")
		...
		.def_static("UTF8toString", &USparkTypes::UTF8toString, py::return_value_policy::reference)
	...
	py::class_< USparkInterface, UInterface >(m, "USparkInterface")
		...
		.def("RemoveScriptCallback", &USparkInterface::RemoveScriptCallback)
		...
		.def("GetGearboxAccountData", &USparkInterface::GetGearboxAccountData, py::return_value_policy::reference)
		.def("IsGearboxAccountAuthenticated", &USparkInterface::IsGearboxAccountAuthenticated)
		...
		.def("GetPlatformLoginNameFromSplitscreenIndex", &USparkInterface::GetPlatformLoginNameFromSplitscreenIndex, py::return_value_policy::reference)
		...
		.def("RestartSparkInitialization", &USparkInterface::RestartSparkInitialization)
		...
		.def("IsSparkEnabled", &USparkInterface::IsSparkEnabled)
	...
	py::class_< UGearboxAccountData, UObject >(m, "UGearboxAccountData")
		...
		.def_readwrite("AgreementsSigning", &UGearboxAccountData::AgreementsSigning)
		.def_readwrite("SupportId", &UGearboxAccountData::SupportId, py::return_value_policy::reference)
		.def("HasSignedAllEulas", &UGearboxAccountData::HasSignedAllEulas)
		...
		.def("GetService", &UGearboxAccountData::GetService, py::return_value_policy::reference)
		.def("Clear", &UGearboxAccountData::Clear)
		.def_static("ExtractArchwayResultJson", &UGearboxAccountData::ExtractArchwayResultJson)
		.def_static("ExtractArchwayResult", &UGearboxAccountData::ExtractArchwayResult)
		;
	py::class_< UGearboxAccountActions, UObject >(m, "UGearboxAccountActions")
		...
		.def("HandleEULAInteractionCompleteResponse", &UGearboxAccountActions::HandleEULAInteractionCompleteResponse)
		.def("HandleEULAInteractionComplete", &UGearboxAccountActions::HandleEULAInteractionComplete)
		.def("HandleEULAChainResponse", &UGearboxAccountActions::HandleEULAChainResponse)
		.def("ReadEULAChain", &UGearboxAccountActions::ReadEULAChain)
		...
		.def("ConsumeEntitlementsWithCounts", &UGearboxAccountActions::ConsumeEntitlementsWithCounts)
	...
	py::class_< AGearboxPlayerController, AGamePlayerController >(m, "AGearboxPlayerController")
		...
		.def("CanPlayOnline", &AGearboxPlayerController::CanPlayOnline)
		.def("DisplayShiftCommunicationFailedDialog", &AGearboxPlayerController::DisplayShiftCommunicationFailedDialog)
		.def("ShowEULAScreen", &AGearboxPlayerController::ShowEULAScreen)
		...
		.def("DisplayStorageRemovedMenu", &AGearboxPlayerController::DisplayStorageRemovedMenu)
		...
		.def("DestroyOnlineGame", &AGearboxPlayerController::DestroyOnlineGame)
		...
		.def("WriteProfile", &AGearboxPlayerController::WriteProfile)
		.def("GetProfileSettings", &AGearboxPlayerController::GetProfileSettings, py::return_value_policy::reference)
		.def("GetMyControllerId", &AGearboxPlayerController::GetMyControllerId)
		.def("ReadProfile", &AGearboxPlayerController::ReadProfile)
		...
		.def("ClientKeepPlayingLoadingMovie", &AGearboxPlayerController::ClientKeepPlayingLoadingMovie)
		.def("ClientResetCamera", &AGearboxPlayerController::ClientResetCamera)
		.def("SpawnPlayerCamera", &AGearboxPlayerController::SpawnPlayerCamera)
		.def("InitInputSystem", &AGearboxPlayerController::InitInputSystem)
		.def("NoTargetAll", &AGearboxPlayerController::NoTargetAll)
		.def("NoTarget", &AGearboxPlayerController::NoTarget)
		.def_static("GetNoTargetPlayers", &AGearboxPlayerController::GetNoTargetPlayers)
		.def_static("SetNoTargetPlayers", &AGearboxPlayerController::SetNoTargetPlayers)
		...
		.def("DisplayDebugSpark", [](AGearboxPlayerController &self , class AHUD* HUD) { float* pyout_YL = (float*)malloc(sizeof(float)) ; float* pyout_YPos = (float*)malloc(sizeof(float)) ;   self.DisplayDebugSpark(HUD, pyout_YL, pyout_YPos); return py::make_tuple(*pyout_YL, *pyout_YPos); })
	...
	py::class_< UGFxActorMoviePool, UObject >(m, "UGFxActorMoviePool")
		...
		.def("DisplayDebug", [](UGFxActorMoviePool &self , class AHUD* HUD, float X) { float* pyout_YL = (float*)malloc(sizeof(float)) ; float* pyout_YPos = (float*)malloc(sizeof(float)) ;   self.DisplayDebug(HUD, X, pyout_YL, pyout_YPos); return py::make_tuple(*pyout_YL, *pyout_YPos); })
		;
	py::class_< UGFxMovieDefinition, UGBXDefinition >(m, "UGFxMovieDefinition")
		...
		;
	py::class_< UGearboxEULAGFxMovieDefinition, UGFxMovieDefinition >(m, "UGearboxEULAGFxMovieDefinition")
		.def_static("StaticClass", &UGearboxEULAGFxMovieDefinition::StaticClass, py::return_value_policy::reference)
		;
	...
	py::class_< UGFxMovieDrawStyleHUD, UGFxMovieDrawStyle >(m, "UGFxMovieDrawStyleHUD")
		...
		.def("RequiresClientInstance", &UGFxMovieDrawStyleHUD::RequiresClientInstance)
		;
	py::class_< UGFxMovieDrawStyleRTT, UGFxMovieDrawStyle >(m, "UGFxMovieDrawStyleRTT")
		...
		;
	py::class_< UGFxMovieDrawStyleComponent, UGFxMovieDrawStyleRTT >(m, "UGFxMovieDrawStyleComponent")
	...
	py::class_< UGFxMovieDrawStyleMesh, UGFxMovieDrawStyleComponent >(m, "UGFxMovieDrawStyleMesh")
		...
		.def("RequiresClientInstance", &UGFxMovieDrawStyleMesh::RequiresClientInstance)
		;
	...
	py::class_< UGFxMovieDrawStyleSplitscreen, UGFxMovieDrawStyle >(m, "UGFxMovieDrawStyleSplitscreen")
		...
		.def("RequiresClientInstance", &UGFxMovieDrawStyleSplitscreen::RequiresClientInstance)
		;
	...
	py::class_< UIAIInterface, UInterface >(m, "UIAIInterface")
		...
		.def("GetAIParent", &UIAIInterface::GetAIParent)
	...
	py::class_< UInterfaceGearboxCamera, UInterface >(m, "UInterfaceGearboxCamera")
		...
		.def("FinishCameraLookAt", &UInterfaceGearboxCamera::FinishCameraLookAt)
	...
	py::class_< UIStreamingDataEvent, UInterface >(m, "UIStreamingDataEvent")
		...
		.def("RunStreamingDataEvent", &UIStreamingDataEvent::RunStreamingDataEvent)
		;
	...
	py::class_< UPopulationAspect, UObject >(m, "UPopulationAspect")
		...
		.def("DenStatRemoved", &UPopulationAspect::DenStatRemoved)
		.def("DenStatAdded", &UPopulationAspect::DenStatAdded)
		.def("EnabledStatusChanged", &UPopulationAspect::EnabledStatusChanged)
		.def("AllActorsRemoved", &UPopulationAspect::AllActorsRemoved)
		.def("OnActorDeath", &UPopulationAspect::OnActorDeath)
		.def("OnSpawnActor", &UPopulationAspect::OnSpawnActor)
		.def("Initialize", &UPopulationAspect::Initialize)
		;
	...
	py::class_< APopulationEncounter, AInfo >(m, "APopulationEncounter")
		...
		.def("TriggerKismetAllSpawnedEvent", &APopulationEncounter::TriggerKismetAllSpawnedEvent)
		.def("TriggerKismetDeathEvent", &APopulationEncounter::TriggerKismetDeathEvent)
	...
	py::class_< URegionDefinition, UGBXDefinition >(m, "URegionDefinition")
		...
		.def("GetDefaultRegionGameStage", [](URegionDefinition &self ) { int* pyMinGameStage = (int*)malloc(sizeof(int)) ; int* pyMaxGameStage = (int*)malloc(sizeof(int)) ; int* pyAwesomeLevel = (int*)malloc(sizeof(int)) ; int* pyGameStageIncreaseOverPlayerLevel = (int*)malloc(sizeof(int)) ;  bool ret =  self.GetDefaultRegionGameStage(pyMinGameStage, pyMaxGameStage, pyAwesomeLevel, pyGameStageIncreaseOverPlayerLevel); return py::make_tuple(ret, *pyMinGameStage, *pyMaxGameStage, *pyAwesomeLevel, *pyGameStageIncreaseOverPlayerLevel); })
		.def("TestRegionGameStage", [](URegionDefinition &self , bool bDefaultGameStage) { int* pyGameStage = (int*)malloc(sizeof(int)) ; int* pyAwesomeLevel = (int*)malloc(sizeof(int)) ;  bool ret =  self.TestRegionGameStage(bDefaultGameStage, pyGameStage, pyAwesomeLevel); return py::make_tuple(ret, *pyGameStage, *pyAwesomeLevel); })
		.def("GetRegionGameStage", [](URegionDefinition &self , bool bDefaultGameStage) { int* pyGameStage = (int*)malloc(sizeof(int)) ; int* pyAwesomeLevel = (int*)malloc(sizeof(int)) ;  bool ret =  self.GetRegionGameStage(bDefaultGameStage, pyGameStage, pyAwesomeLevel); return py::make_tuple(ret, *pyGameStage, *pyAwesomeLevel); })
		;
	...
	py::class_< USpecialMoveDefinition, UGBXDefinition >(m, "USpecialMoveDefinition")
		...
		.def("IsPlayingLocally", &USpecialMoveDefinition::IsPlayingLocally)
		...
		.def("ClientFinished", &USpecialMoveDefinition::ClientFinished)
		.def("ServerFinished", &USpecialMoveDefinition::ServerFinished)
		.def("ClientStarted", &USpecialMoveDefinition::ClientStarted)
		.def("ServerStarted", &USpecialMoveDefinition::ServerStarted)
		.def("IsLocalAuthority", &USpecialMoveDefinition::IsLocalAuthority)
		.def("AuthorityCanPlay", &USpecialMoveDefinition::AuthorityCanPlay)
		;
	...
	py::class_< AWireTerminal, AStaticMeshActor >(m, "AWireTerminal")
		...
		.def("Destroyed", &AWireTerminal::Destroyed)
	...
	py::class_< UAIComponent, UActorComponent >(m, "UAIComponent")
		...
		.def_static("GetAIRangeTime", &UAIComponent::GetAIRangeTime)
	...
	py::class_< UFlagDefinition, UGBXDefinition >(m, "UFlagDefinition")
		...
		.def_static("ApplyFlagInitializationData", &UFlagDefinition::ApplyFlagInitializationData)
	...
	py::class_< UActionSequence, UObject >(m, "UActionSequence")
		...
		.def("ScriptCleanUp", &UActionSequence::ScriptCleanUp)
		.def("CanRun", &UActionSequence::CanRun, py::return_value_policy::reference)
		.def("ActivateEvent", &UActionSequence::ActivateEvent)
		.def("Update", &UActionSequence::Update)
		.def("Init", &UActionSequence::Init)
		.def("Stop", &UActionSequence::Stop)
		.def("Start", &UActionSequence::Start)
		.def("InterruptSequence", &UActionSequence::InterruptSequence)
		.def("StopSequence", &UActionSequence::StopSequence)
		.def("StartSequence", &UActionSequence::StartSequence)
	...
	py::class_< UAction_PawnMovementBase, UActionSequencePawn >(m, "UAction_PawnMovementBase")
		...
		.def("PostMovement", &UAction_PawnMovementBase::PostMovement)
		.def("PreMovement", &UAction_PawnMovementBase::PreMovement)
		.def("PrePathFind", &UAction_PawnMovementBase::PrePathFind)
		.def("InterruptSequence", &UAction_PawnMovementBase::InterruptSequence)
		.def("StopSequence", &UAction_PawnMovementBase::StopSequence)
		.def("StartSequence", &UAction_PawnMovementBase::StartSequence)
	...
	py::class_< UExposureUtilityBasicCaching, UExposureUtilityBase >(m, "UExposureUtilityBasicCaching")
		...
		;
	py::class_< UExposureUtilityFixedCost, UExposureUtilityBasicCaching >(m, "UExposureUtilityFixedCost")
	...
	py::class_< UFiringBehaviorManager, UObject >(m, "UFiringBehaviorManager")
		...
		.def_static("GetTemplateClass", &UFiringBehaviorManager::GetTemplateClass, py::return_value_policy::reference)
		;
	...
	py::class_< UFiringZoneCollectionDefinition, UGBXDefinition >(m, "UFiringZoneCollectionDefinition")
		...
		.def("GetZoneForDistance", &UFiringZoneCollectionDefinition::GetZoneForDistance, py::return_value_policy::reference)
		;
	...
	py::class_< URuleEngine, UObject >(m, "URuleEngine")
		...
		;
	py::class_< AGearboxMind, AGearboxAIController >(m, "AGearboxMind")
		...
		.def("GetAIParent", &AGearboxMind::GetAIParent)
		...
		.def_static("GetNoTargetAllEnemies", &AGearboxMind::GetNoTargetAllEnemies)
		.def_static("SetNoTargetAllEnemies", &AGearboxMind::SetNoTargetAllEnemies)
		.def("ClearScriptedMoveTarget", &AGearboxMind::ClearScriptedMoveTarget)
		.def("IsCloseEnoughToScriptedMoveTarget", &AGearboxMind::IsCloseEnoughToScriptedMoveTarget)
		.def("GetWeaponFireLocation", &AGearboxMind::GetWeaponFireLocation, py::return_value_policy::reference)
		...
		.def("Possess", &AGearboxMind::Possess)
	...
	py::class_< UGearboxNavigationHandle, UNavigationHandle >(m, "UGearboxNavigationHandle")
		...
		.def_static("GetNearestPositionOnNavMesh", &UGearboxNavigationHandle::GetNearestPositionOnNavMesh)
		.def_static("GetNavMeshPolyForPoint", &UGearboxNavigationHandle::GetNavMeshPolyForPoint)
	...
	py::class_< UKnowledgeRecord, UObject >(m, "UKnowledgeRecord")
		...
		.def("RecordEvalCallback", &UKnowledgeRecord::RecordEvalCallback)
		;
	...
	py::class_< URulePlaceholder, URule >(m, "URulePlaceholder")
		...
		;
	py::class_< UGearboxRuleEngine, URuleEngine >(m, "UGearboxRuleEngine")
	...
	py::class_< UTargetIterator, UObject >(m, "UTargetIterator")
		...
		.def_static("RecordEvalCallback", &UTargetIterator::RecordEvalCallback)
		;
	...
	py::class_< UTargetIteratorPrioritizeTargetsIAmExposedTo, UTargetIterator >(m, "UTargetIteratorPrioritizeTargetsIAmExposedTo")
		...
		;
	py::class_< UTI_Calc, UTargetIterator >(m, "UTI_Calc")
	...
	py::class_< UPopulationDefinition, UGBXDefinition >(m, "UPopulationDefinition")
		...
		.def_static("IsAllSpawnTypesDebugEnabled", &UPopulationDefinition::IsAllSpawnTypesDebugEnabled)
		.def_static("ToggleAllSpawnTypesDebug", &UPopulationDefinition::ToggleAllSpawnTypesDebug)
	...
	py::class_< UPopulationFactory, UObject >(m, "UPopulationFactory")
		...
		.def("GetDescriptionOfFactoryOutput", &UPopulationFactory::GetDescriptionOfFactoryOutput, py::return_value_policy::reference)
		.def_static("ShouldSavePopulationActor", &UPopulationFactory::ShouldSavePopulationActor)
		.def_static("DestroyPopulationActor", &UPopulationFactory::DestroyPopulationActor)
		.def("CreatePopulationActor", &UPopulationFactory::CreatePopulationActor, py::return_value_policy::reference)
		.def("GetSpawnVisibilityBounds", &UPopulationFactory::GetSpawnVisibilityBounds, py::return_value_policy::reference)
		.def("GetActorAllegiance", &UPopulationFactory::GetActorAllegiance, py::return_value_policy::reference)
		.def("GetActorSpawnCost", &UPopulationFactory::GetActorSpawnCost)
		.def("OnSpawnActor", &UPopulationFactory::OnSpawnActor)
		.def_static("SetupMatineeForActor", &UPopulationFactory::SetupMatineeForActor)
	...
	py::class_< UPopulationFactoryGeneric, UPopulationFactory >(m, "UPopulationFactoryGeneric")
		...
		.def("CreatePopulationActor", &UPopulationFactoryGeneric::CreatePopulationActor, py::return_value_policy::reference)
		.def("GetSpawnVisibilityBounds", &UPopulationFactoryGeneric::GetSpawnVisibilityBounds, py::return_value_policy::reference)
		;
	...
	py::class_< APopulationOpportunity, AInfo >(m, "APopulationOpportunity")
		...
		.def_readwrite("Aspects", &APopulationOpportunity::Aspects, py::return_value_policy::reference)
		...
		.def("GetBodyInfoProvider", &APopulationOpportunity::GetBodyInfoProvider)
		...
		.def("Destroyed", &APopulationOpportunity::Destroyed)
		.def("GetRarity", &APopulationOpportunity::GetRarity)
		.def("GetGameStage", &APopulationOpportunity::GetGameStage)
		.def("TriggerKismetAllSpawnedEvent", &APopulationOpportunity::TriggerKismetAllSpawnedEvent)
		.def("ClearSequenceActionLink", &APopulationOpportunity::ClearSequenceActionLink)
		.def("SetSequenceActionLink", &APopulationOpportunity::SetSequenceActionLink)
		...
		.def("GetOpportunityGameStage", [](APopulationOpportunity &self ) { int* pyGameStage = (int*)malloc(sizeof(int)) ; int* pyRarity = (int*)malloc(sizeof(int)) ;  bool ret =  self.GetOpportunityGameStage(pyGameStage, pyRarity); return py::make_tuple(ret, *pyGameStage, *pyRarity); })
		.def("GetNumLeftToSpawnAndStillAlive", [](APopulationOpportunity &self ) { int* pyNumLeftToSpawn = (int*)malloc(sizeof(int)) ; int* pyNumStillAlive = (int*)malloc(sizeof(int)) ;   self.GetNumLeftToSpawnAndStillAlive(pyNumLeftToSpawn, pyNumStillAlive); return py::make_tuple(*pyNumLeftToSpawn, *pyNumStillAlive); })
		;
	py::class_< UPopulationMaster, UObject >(m, "UPopulationMaster")
		...
		.def_static("GetStreamingLevelForActor", &UPopulationMaster::GetStreamingLevelForActor, py::return_value_policy::reference)
	...
	py::class_< APopulationOpportunityArea, APopulationOpportunity >(m, "APopulationOpportunityArea")
		...
		.def("GetBodyInfoProvider", &APopulationOpportunityArea::GetBodyInfoProvider)
	...
	py::class_< APopulationOpportunityCloner, APopulationOpportunity >(m, "APopulationOpportunityCloner")
		...
		.def("GetBodyInfoProvider", &APopulationOpportunityCloner::GetBodyInfoProvider)
	...
	py::class_< APopulationOpportunityCombat, APopulationOpportunity >(m, "APopulationOpportunityCombat")
		...
		.def("GetBodyInfoProvider", &APopulationOpportunityCombat::GetBodyInfoProvider)
		.def("TriggerKismetSingleDeathEvent", &APopulationOpportunityCombat::TriggerKismetSingleDeathEvent)
		.def("TriggerKismetDeathEvent", &APopulationOpportunityCombat::TriggerKismetDeathEvent)
	...
	py::class_< APopulationOpportunityPoint, APopulationOpportunity >(m, "APopulationOpportunityPoint")
		...
		.def("GetBodyInfoProvider", &APopulationOpportunityPoint::GetBodyInfoProvider)
	...
	py::class_< USeqEvent_PopulatedActor, USequenceEvent >(m, "USeqEvent_PopulatedActor")
		...
		.def("NotifyPopulatedActor", &USeqEvent_PopulatedActor::NotifyPopulatedActor)
		;
	py::class_< USeqEvent_PopulatedPoint, USequenceEvent >(m, "USeqEvent_PopulatedPoint")
		...
		.def("NotifyPopulatedActor", &USeqEvent_PopulatedPoint::NotifyPopulatedActor)
		;
	...
	py::class_< UBehaviorProviderDefinition, UGBXDefinition >(m, "UBehaviorProviderDefinition")
		...
		.def_static("SetObjectBehaviorVariable", &UBehaviorProviderDefinition::SetObjectBehaviorVariable)
		.def_static("SetVectorBehaviorVariable", &UBehaviorProviderDefinition::SetVectorBehaviorVariable)
		.def_static("SetFloatBehaviorVariable", &UBehaviorProviderDefinition::SetFloatBehaviorVariable)
		.def_static("SetIntBehaviorVariable", &UBehaviorProviderDefinition::SetIntBehaviorVariable)
		.def_static("SetBoolBehaviorVariable", &UBehaviorProviderDefinition::SetBoolBehaviorVariable)
		;
	py::class_< UBehaviorKernel, UObject >(m, "UBehaviorKernel")
		...
		.def_static("IsBehaviorKernelWatchingConsumer", &UBehaviorKernel::IsBehaviorKernelWatchingConsumer)
		.def_static("IsBehaviorSequenceEnabled", &UBehaviorKernel::IsBehaviorSequenceEnabled)
		.def_static("ActivateBehaviorOutputLink", &UBehaviorKernel::ActivateBehaviorOutputLink)
		.def_static("PublishBoolOutputVariable", &UBehaviorKernel::PublishBoolOutputVariable)
		.def_static("PublishObjectOutputVariable", &UBehaviorKernel::PublishObjectOutputVariable)
		.def_static("PublishVectorOutputVariable", &UBehaviorKernel::PublishVectorOutputVariable)
		.def_static("PublishFloatOutputVariable", &UBehaviorKernel::PublishFloatOutputVariable)
		.def_static("PublishIntOutputVariable", &UBehaviorKernel::PublishIntOutputVariable)
		.def_static("BeginNondeterministicProviderRegistration", &UBehaviorKernel::BeginNondeterministicProviderRegistration)
		.def_static("ProcessReplicatedBehaviorEvent", &UBehaviorKernel::ProcessReplicatedBehaviorEvent)
		.def_static("ProcessReplicatedBehaviorConsumerState", &UBehaviorKernel::ProcessReplicatedBehaviorConsumerState)
		.def_static("ChangeBehaviorSequenceActivationStatus", &UBehaviorKernel::ChangeBehaviorSequenceActivationStatus)
		.def_static("ChangeBehaviorConsumerSuspensionStatus", &UBehaviorKernel::ChangeBehaviorConsumerSuspensionStatus)
		.def_static("BroadcastBehaviorEventFromScript", &UBehaviorKernel::BroadcastBehaviorEventFromScript)
		.def_static("ActivateBehaviorEventFromScript", &UBehaviorKernel::ActivateBehaviorEventFromScript)
		.def_static("RemoveBehaviorProviderFromConsumer", &UBehaviorKernel::RemoveBehaviorProviderFromConsumer)
		.def_static("IntializeBehaviorProviderForConsumer", &UBehaviorKernel::IntializeBehaviorProviderForConsumer)
		.def_static("ForceUnregisterBehaviorConsumer", &UBehaviorKernel::ForceUnregisterBehaviorConsumer)
		.def_static("RegisterBehaviorConsumer", &UBehaviorKernel::RegisterBehaviorConsumer, py::return_value_policy::reference)
	...
	py::class_< UICustomEvent, UInterface >(m, "UICustomEvent")
		...
		.def("RunCustomEvent", &UICustomEvent::RunCustomEvent)
		;
	py::class_< UGearboxAnimDefinition, USpecialMoveDefinition >(m, "UGearboxAnimDefinition")
		...
		.def("IsPlayingLocally", &UGearboxAnimDefinition::IsPlayingLocally)
		...
		.def("AnimFinished", &UGearboxAnimDefinition::AnimFinished)
		.def("ClientFinished", &UGearboxAnimDefinition::ClientFinished)
		.def("ClientStarted", &UGearboxAnimDefinition::ClientStarted)
		.def("ServerFinished", &UGearboxAnimDefinition::ServerFinished)
		.def("ServerStarted", &UGearboxAnimDefinition::ServerStarted)
		...
		.def("AuthorityCanPlay", &UGearboxAnimDefinition::AuthorityCanPlay)
	...
	py::class_< AGearboxDialogActor, AActor >(m, "AGearboxDialogActor")
		...
		.def("ServerDialog_TriggerEvent", &AGearboxDialogActor::ServerDialog_TriggerEvent)
		.def("ReplicatedEvent", &AGearboxDialogActor::ReplicatedEvent)
		;
	py::class_< UGearboxDialogComponent, UActorComponent >(m, "UGearboxDialogComponent")
		...
		.def("GetDialogInterface", &UGearboxDialogComponent::GetDialogInterface)
		.def("GetMatchingEvent", [](UGearboxDialogComponent &self , class UGearboxDialogEventTag* InEventTag, bool bIncludeDisabled, class UGearboxDialogNameTag* OtherNameTag, bool bAllowTemplateGroups) { class UGearboxDialogEvent** pyOutEvent = 0 ; class UGearboxDialogGroup** pyOutGroup = 0 ;   self.GetMatchingEvent(InEventTag, bIncludeDisabled, OtherNameTag, bAllowTemplateGroups, pyOutEvent, pyOutGroup); return py::make_tuple(*pyOutEvent, *pyOutGroup); })
		;
	...
	py::class_< UGearboxDialogPriority, UGBXDefinition >(m, "UGearboxDialogPriority")
		...
		;
	py::class_< UGearboxDialogNode, UGearboxEditorNode >(m, "UGearboxDialogNode")
	...
	py::class_< UGearboxDialogAction, UGearboxDialogNode >(m, "UGearboxDialogAction")
		...
		.def("Activate", &UGearboxDialogAction::Activate)
		;
	py::class_< UGearboxDialogAct_Chance, UGearboxDialogAction >(m, "UGearboxDialogAct_Chance")
		...
		.def("Activate", &UGearboxDialogAct_Chance::Activate)
		;
	py::class_< UGearboxDialogAct_Compare, UGearboxDialogAction >(m, "UGearboxDialogAct_Compare")
		...
		.def("Activate", &UGearboxDialogAct_Compare::Activate)
		;
	py::class_< UGearboxDialogAct_ObjectParameterSwitch, UGearboxDialogAction >(m, "UGearboxDialogAct_ObjectParameterSwitch")
		...
		.def("Activate", &UGearboxDialogAct_ObjectParameterSwitch::Activate)
		;
	py::class_< UGearboxDialogNonTemplateAction, UGearboxDialogAction >(m, "UGearboxDialogNonTemplateAction")
		.def_static("StaticClass", &UGearboxDialogNonTemplateAction::StaticClass, py::return_value_policy::reference)
		;
	py::class_< UGearboxDialogAct_Talk, UGearboxDialogNonTemplateAction >(m, "UGearboxDialogAct_Talk")
		...
		.def("Activate", &UGearboxDialogAct_Talk::Activate)
		.def("TalkFinished", &UGearboxDialogAct_Talk::TalkFinished)
		.def("TalkStarted", &UGearboxDialogAct_Talk::TalkStarted)
		;
	py::class_< UGearboxDialogTemplateAction, UGearboxDialogAction >(m, "UGearboxDialogTemplateAction")
		...
		;
	py::class_< UGearboxDialogAct_Trigger, UGearboxDialogTemplateAction >(m, "UGearboxDialogAct_Trigger")
		...
		.def("Activate", &UGearboxDialogAct_Trigger::Activate)
		;
	py::class_< UGearboxDialogEvent, UGearboxDialogNode >(m, "UGearboxDialogEvent")
	...
	py::class_< UGearboxProcess, UObject >(m, "UGearboxProcess")
		...
		.def("PerformStep", &UGearboxProcess::PerformStep)
		...
		;
	py::class_< USparkInitializationProcess, UGearboxProcess >(m, "USparkInitializationProcess")
		...
		.def("TriggerSparkInitializedDelegates", &USparkInitializationProcess::TriggerSparkInitializedDelegates)
		...
		.def_static("UpdateAgreementsSigning", &USparkInitializationProcess::UpdateAgreementsSigning)
		.def("HandleVerificationReceived", &USparkInitializationProcess::HandleVerificationReceived)
		.def("VerifyAuthentication", &USparkInitializationProcess::VerifyAuthentication)
		...
		.def("AuthenticateAccount", &USparkInitializationProcess::AuthenticateAccount)
	...
	py::class_< ULeviathanService, UObject >(m, "ULeviathanService")
		...
		.def("GetLeviathanServiceConfiguration", &ULeviathanService::GetLeviathanServiceConfiguration, py::return_value_policy::reference)
		...
		.def_static("GetLeviathanService", &ULeviathanService::GetLeviathanService, py::return_value_policy::reference)
		;
	py::class_< USparkInterfaceImpl, UObject >(m, "USparkInterfaceImpl")
		...
		.def("RemoveScriptCallback", &USparkInterfaceImpl::RemoveScriptCallback)
		...
		.def("RestartSparkInitialization", &USparkInterfaceImpl::RestartSparkInitialization)
		...
		.def("GetGearboxAccountData", &USparkInterfaceImpl::GetGearboxAccountData, py::return_value_policy::reference)
		...
		.def("IsGearboxAccountAuthenticated", &USparkInterfaceImpl::IsGearboxAccountAuthenticated)
		...
		.def("GetPlatformLoginNameFromSplitscreenIndex", &USparkInterfaceImpl::GetPlatformLoginNameFromSplitscreenIndex, py::return_value_policy::reference)
		.def("GetPlatformLoginName", &USparkInterfaceImpl::GetPlatformLoginName, py::return_value_policy::reference)
		.def("GetLoginStatus", &USparkInterfaceImpl::GetLoginStatus)
		.def("IsShiftEnabled", &USparkInterfaceImpl::IsShiftEnabled)
		.def("IsSparkEnabled", &USparkInterfaceImpl::IsSparkEnabled)
		.def_static("WithShift", &USparkInterfaceImpl::WithShift)
		.def_static("WithSpark", &USparkInterfaceImpl::WithSpark)
	...
	py::class_< USparkServiceConfiguration, UObject >(m, "USparkServiceConfiguration")
		...
		.def("GetBoolParameter", &USparkServiceConfiguration::GetBoolParameter)
	...
	py::class_< UAction_FaceThreat, UActionSequencePawn >(m, "UAction_FaceThreat")
		...
		.def("StopSequence", &UAction_FaceThreat::StopSequence)
		;
	py::class_< URES_FacingPolicy, UActionResource >(m, "URES_FacingPolicy")
	...
	py::class_< UAIState_Priority, UAIStateBase >(m, "UAIState_Priority")
		...
		;
	py::class_< UAIState_Random, UAIStateBase >(m, "UAIState_Random")
	...
	py::class_< UCameraModifierCrossfade, UGearboxCameraModifier >(m, "UCameraModifierCrossfade")
		...
		.def("EnableModifier", &UCameraModifierCrossfade::EnableModifier)
		;
	py::class_< UCameraModifierLookAt, UGearboxCameraModifier >(m, "UCameraModifierLookAt")
	...
	py::class_< APatrolDestination, AActor >(m, "APatrolDestination")
		...
		;
	py::class_< UGearboxEULAGFxMovie, UGearboxGFxMovie >(m, "UGearboxEULAGFxMovie")
		.def_static("StaticClass", &UGearboxEULAGFxMovie::StaticClass, py::return_value_policy::reference)
		.def_readwrite("GearboxEULAObj", &UGearboxEULAGFxMovie::GearboxEULAObj, py::return_value_policy::reference)
		.def_readwrite("CurrentControllerId", &UGearboxEULAGFxMovie::CurrentControllerId)
		.def_readwrite("EULAs", &UGearboxEULAGFxMovie::EULAs, py::return_value_policy::reference)
		.def_readwrite("EULAIndexToDisplay", &UGearboxEULAGFxMovie::EULAIndexToDisplay)
		.def_readwrite("__OnEULAInteractionComplete__Delegate", &UGearboxEULAGFxMovie::__OnEULAInteractionComplete__Delegate, py::return_value_policy::reference)
		.def("HandleInputKey", &UGearboxEULAGFxMovie::HandleInputKey)
		.def("ShowEULA", &UGearboxEULAGFxMovie::ShowEULA)
		.def("OnDeclineButtonClick", &UGearboxEULAGFxMovie::OnDeclineButtonClick)
		.def("OnAcceptButtonClick", &UGearboxEULAGFxMovie::OnAcceptButtonClick)
		.def("FireCompleteDelegate", &UGearboxEULAGFxMovie::FireCompleteDelegate)
		.def("extClosed", &UGearboxEULAGFxMovie::extClosed)
		.def("extOnDeclineButtonClick", &UGearboxEULAGFxMovie::extOnDeclineButtonClick)
		.def("extOnAcceptButtonClick", &UGearboxEULAGFxMovie::extOnAcceptButtonClick)
		.def("extOnLoad", &UGearboxEULAGFxMovie::extOnLoad)
		.def("OnClose", &UGearboxEULAGFxMovie::OnClose)
		.def("Start", &UGearboxEULAGFxMovie::Start)
		.def("OnEULAInteractionComplete", &UGearboxEULAGFxMovie::OnEULAInteractionComplete)
		;
	py::class_< UGearboxEULAGFxObject, UGFxObject >(m, "UGearboxEULAGFxObject")
		.def_static("StaticClass", &UGearboxEULAGFxObject::StaticClass, py::return_value_policy::reference)
		.def("NavigateDown", &UGearboxEULAGFxObject::NavigateDown)
		.def("NavigateUp", &UGearboxEULAGFxObject::NavigateUp)
		.def("SetTooltipText", &UGearboxEULAGFxObject::SetTooltipText)
		.def("SetEULAText", &UGearboxEULAGFxObject::SetEULAText)
		.def("Init", &UGearboxEULAGFxObject::Init)
		;
	...
	py::class_< UGFxMovieDrawStyleInstanceData, UGFxMovieDrawStyleRTT >(m, "UGFxMovieDrawStyleInstanceData")
		...
		.def("RequiresClientInstance", &UGFxMovieDrawStyleInstanceData::RequiresClientInstance)
		;
