...
void Export_pystes_GearboxFramework_structs(py::module &m)
{
	...
	py::class_< FAITreeData >(m, "FAITreeData")
		...
		.def_readwrite("UnknownData00[0x4]", &FAITreeData::UnknownData00[0x4])
	...
	py::class_< FGearboxCoverTransition >(m, "FGearboxCoverTransition")
		...
		.def_readwrite("Padding[0x2]", &FGearboxCoverTransition::Padding[0x2])
		;
	...
	py::class_< FTimerBehaviorUserState >(m, "FTimerBehaviorUserState")
		.def_readwrite("Timers[0x3]", &FTimerBehaviorUserState::Timers[0x3], py::return_value_policy::reference)
		;
	...
	py::class_< FAttachmentLocationData >(m, "FAttachmentLocationData")
		...
		.def_readwrite("UnknownData00[0x4]", &FAttachmentLocationData::UnknownData00[0x4])
	...
	py::class_< FHUDAnchorPoint >(m, "FHUDAnchorPoint")
		...
		.def_readwrite("Offset[0x2]", &FHUDAnchorPoint::Offset[0x2], py::return_value_policy::reference)
		;
