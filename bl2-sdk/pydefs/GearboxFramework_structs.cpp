...
void Export_pystes_GearboxFramework_structs(py::module &m)
{
	...
	py::class_< FHttpParameters >(m, "FHttpParameters")
		...
		.def_property("NoRetry", [](FHttpParameters &self){return self.NoRetry;}, [](FHttpParameters &self, bool value){self.NoRetry = value ? 1 : 0;})
	...
	py::class_< FArchwayResult >(m, "FArchwayResult")
		...
		.def_readwrite("NeedsSignAgreements", &FArchwayResult::NeedsSignAgreements, py::return_value_policy::reference)
		.def_readwrite("EulaArray", &FArchwayResult::EulaArray, py::return_value_policy::reference)
		.def_readwrite("SupportId", &FArchwayResult::SupportId, py::return_value_policy::reference)
		;
	py::class_< FEULAData >(m, "FEULAData")
		.def(py::init<>())
		.def_property("bLocalSigned", [](FEULAData &self){return self.bLocalSigned;}, [](FEULAData &self, bool value){self.bLocalSigned = value ? 1 : 0;})
		.def_property("bSeen", [](FEULAData &self){return self.bSeen;}, [](FEULAData &self, bool value){self.bSeen = value ? 1 : 0;})
		.def_readwrite("Id", &FEULAData::Id)
		.def_readwrite("Version", &FEULAData::Version, py::return_value_policy::reference)
		.def_readwrite("Title", &FEULAData::Title, py::return_value_policy::reference)
		.def_readwrite("Text", &FEULAData::Text, py::return_value_policy::reference)
		;
