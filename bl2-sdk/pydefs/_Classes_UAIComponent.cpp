...
{
    class_< UAIComponent, bases< UActorComponent >  , boost::noncopyable>("UAIComponent", no_init)
        ...
        .def("StaticClass", &UAIComponent::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetTargetRecordFor", &UAIComponent::GetTargetRecordFor, return_value_policy< reference_existing_object >())
        .def("GetTargetRecord", &UAIComponent::GetTargetRecord, return_value_policy< reference_existing_object >())
        .def("IsTarget", &UAIComponent::IsTarget)
        .def("GetTarget", &UAIComponent::GetTarget, return_value_policy< reference_existing_object >())
        ...
        .def("AddTarget", &UAIComponent::AddTarget, return_value_policy< reference_existing_object >())
        .def("GetParentComponent", &UAIComponent::GetParentComponent, return_value_policy< reference_existing_object >())
        .def("GetAllegiance", &UAIComponent::GetAllegiance, return_value_policy< reference_existing_object >())
