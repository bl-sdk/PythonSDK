...
{
    class_< AGameInfo, bases< AInfo >  , boost::noncopyable>("AGameInfo", no_init)
        ...
        .def_readonly("UnknownData00", &AGameInfo::UnknownData00)
        ...
        .def("StaticClass", &AGameInfo::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("TellClientsToTravelToSession", &AGameInfo::TellClientsToTravelToSession)
        ...
        .def("eventHandleSeamlessTravelPlayer", &AGameInfo::eventHandleSeamlessTravelPlayer)
        ...
        .def("ChoosePlayerStart", &AGameInfo::ChoosePlayerStart, return_value_policy< reference_existing_object >())
        .def("FindPlayerStart", &AGameInfo::FindPlayerStart, return_value_policy< reference_existing_object >())
        ...
        .def("ReduceDamage", &AGameInfo::ReduceDamage)
        .def("eventShouldOverrideDamageTypeForHealing", &AGameInfo::eventShouldOverrideDamageTypeForHealing)
        .def("eventGetHealingDamageTypeDefinition", &AGameInfo::eventGetHealingDamageTypeDefinition, return_value_policy< reference_existing_object >())
        ...
        .def("GetDefaultPlayerClass", &AGameInfo::GetDefaultPlayerClass, return_value_policy< reference_existing_object >())
        .def("SpawnDefaultPawnFor", &AGameInfo::SpawnDefaultPawnFor, return_value_policy< reference_existing_object >())
        ...
        .def("eventLogin", &AGameInfo::eventLogin, return_value_policy< reference_existing_object >())
        .def("SpawnPlayerController", &AGameInfo::SpawnPlayerController, return_value_policy< reference_existing_object >())
        ...
        .def("PauseLogin", &AGameInfo::PauseLogin, return_value_policy< reference_existing_object >())
        .def("eventPreLogin", &AGameInfo::eventPreLogin)
        .def("RequiresPassword", &AGameInfo::RequiresPassword)
        .def("ProcessClientTravel", &AGameInfo::ProcessClientTravel, return_value_policy< reference_existing_object >())
        ...
        .def("eventSetGameType", &AGameInfo::eventSetGameType, return_value_policy< reference_existing_object >())
        ...
        .def("GetCoverReplicator", &AGameInfo::GetCoverReplicator, return_value_policy< reference_existing_object >())
