...
{
    class_< UWillowHUDGFxMovie, bases< UWillowGFxMovie >  , boost::noncopyable>("UWillowHUDGFxMovie", no_init)
        ...
        .def_readonly("CachedAllyExists", &UWillowHUDGFxMovie::CachedAllyExists)
        .def_readonly("bCachedAllyInjured", &UWillowHUDGFxMovie::bCachedAllyInjured)
        .def_readonly("bCachedAllyReviving", &UWillowHUDGFxMovie::bCachedAllyReviving)
        ...
        .def_readonly("CachedExCurrency", &UWillowHUDGFxMovie::CachedExCurrency)
        ...
        .def_readonly("CachedAllyName", &UWillowHUDGFxMovie::CachedAllyName)
        .def_readonly("CachedAllyClassModNamePart", &UWillowHUDGFxMovie::CachedAllyClassModNamePart)
        .def_readonly("CachedAllyHealth", &UWillowHUDGFxMovie::CachedAllyHealth)
        .def_readonly("CachedAllyMaxHealth", &UWillowHUDGFxMovie::CachedAllyMaxHealth)
        .def_readonly("CachedAllyShields", &UWillowHUDGFxMovie::CachedAllyShields)
        .def_readonly("CachedAllyMaxShields", &UWillowHUDGFxMovie::CachedAllyMaxShields)
        .def_readonly("CachedAllyLevel", &UWillowHUDGFxMovie::CachedAllyLevel)
        .def_readonly("CachedAllyPlayerNameIds", &UWillowHUDGFxMovie::CachedAllyPlayerNameIds)
        .def_readonly("CachedAllyInjuredPct", &UWillowHUDGFxMovie::CachedAllyInjuredPct)
        .def_readonly("CachedAllyTeamBuffs", &UWillowHUDGFxMovie::CachedAllyTeamBuffs)
        .def_readwrite("CurrentTargetable", &UWillowHUDGFxMovie::CurrentTargetable)
        .def_readonly("UnknownData00", &UWillowHUDGFxMovie::UnknownData00)
        .def_readwrite("LastTargetable", &UWillowHUDGFxMovie::LastTargetable)
        .def_readonly("UnknownData01", &UWillowHUDGFxMovie::UnknownData01)
        .def_readwrite("FadingTargetable", &UWillowHUDGFxMovie::FadingTargetable)
        .def_readonly("UnknownData02", &UWillowHUDGFxMovie::UnknownData02)
        ...
        .def_readonly("CachedTSkillIcon_TrigResp", &UWillowHUDGFxMovie::CachedTSkillIcon_TrigResp)
        .def_readwrite("CachedTSkillIcon_Flask", &UWillowHUDGFxMovie::CachedTSkillIcon_Flask)
        .def_readonly("CachedTSkillIcon_Kill", &UWillowHUDGFxMovie::CachedTSkillIcon_Kill)
        ...
        .def("StaticClass", &UWillowHUDGFxMovie::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetPrimaryPlayerWPC", &UWillowGFxMovie3D::GetPrimaryPlayerWPC, return_value_policy< reference_existing_object >())
        ...
        .def("GetViewport", &UWillowGFxMovie3D::GetViewport, return_value_policy< reference_existing_object >())
        ...
        .def("GetParentClip", &UWillowGFxMovie3D::GetParentClip, return_value_policy< reference_existing_object >())
