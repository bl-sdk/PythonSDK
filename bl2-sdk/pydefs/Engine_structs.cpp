...
void Export_pystes_Engine_structs(py::module &m)
{
	py::class_< FStaticMeshLODElement >(m, "FStaticMeshLODElement")
		...
		.def_readwrite("UnknownData00[0x4]", &FStaticMeshLODElement::UnknownData00[0x4])
		;
	...
	py::class_< FRigidBodyState >(m, "FRigidBodyState")
		...
		.def_readwrite("UnknownData00[0x4]", &FRigidBodyState::UnknownData00[0x4])
	...
	py::class_< FRigidBodyContactInfo >(m, "FRigidBodyContactInfo")
		...
		.def_readwrite("ContactVelocity[0x2]", &FRigidBodyContactInfo::ContactVelocity[0x2], py::return_value_policy::reference)
		.def_readwrite("PhysMaterial[0x2]", &FRigidBodyContactInfo::PhysMaterial[0x2], py::return_value_policy::reference)
		;
	...
	py::class_< FUniqueNetId >(m, "FUniqueNetId")
		...
		.def_readwrite("NpId[0x10]", &FUniqueNetId::NpId[0x10])
		;
	...
	py::class_< FBonePair >(m, "FBonePair")
		.def_readwrite("Bones[0x2]", &FBonePair::Bones[0x2], py::return_value_policy::reference)
		;
	...
	py::class_< FCompressedTrack >(m, "FCompressedTrack")
		...
		.def_readwrite("Mins[0x3]", &FCompressedTrack::Mins[0x3])
		.def_readwrite("Ranges[0x3]", &FCompressedTrack::Ranges[0x3])
		;
	py::class_< FDeltaTrackInfo >(m, "FDeltaTrackInfo")
		.def_readwrite("RotKey[0x2]", &FDeltaTrackInfo::RotKey[0x2], py::return_value_policy::reference)
		.def_readwrite("PosKey[0x2]", &FDeltaTrackInfo::PosKey[0x2], py::return_value_policy::reference)
		.def_readwrite("RotKeyIndex[0x2]", &FDeltaTrackInfo::RotKeyIndex[0x2])
		.def_readwrite("PosKeyIndex[0x2]", &FDeltaTrackInfo::PosKeyIndex[0x2])
		;
	...
	py::class_< FAimComponent >(m, "FAimComponent")
		...
		.def_readwrite("UnknownData00[0x8]", &FAimComponent::UnknownData00[0x8])
	...
	py::class_< FCounterBehaviorUserState >(m, "FCounterBehaviorUserState")
		.def_readwrite("Counters[0x2]", &FCounterBehaviorUserState::Counters[0x2], py::return_value_policy::reference)
		;
	...
	py::class_< FCameraShakeInstance >(m, "FCameraShakeInstance")
		...
		.def_readwrite("UnknownData00[0xB]", &FCameraShakeInstance::UnknownData00[0xB])
	...
	py::class_< FUIDataStoreBinding >(m, "FUIDataStoreBinding")
		...
		.def_readwrite("UnknownData00[0x4]", &FUIDataStoreBinding::UnknownData00[0x4])
	...
	py::class_< FUIAxisEmulationDefinition >(m, "FUIAxisEmulationDefinition")
		...
		.def_readwrite("InputKeyToEmulate[0x2]", &FUIAxisEmulationDefinition::InputKeyToEmulate[0x2], py::return_value_policy::reference)
		;
	...
	py::class_< FDamageEventSummary >(m, "FDamageEventSummary")
		...
		.def_readwrite("DamageTakenSkillEventsTriggered[0x8]", &FDamageEventSummary::DamageTakenSkillEventsTriggered[0x8])
		.def_readwrite("DamageDealtSkillEventsTriggered[0x8]", &FDamageEventSummary::DamageDealtSkillEventsTriggered[0x8])
		;
	...
	py::class_< FStoredFoliageInstance, UAudioDevice >(m, "FStoredFoliageInstance")
		.def_readwrite("StaticLighting[0x3]", &FStoredFoliageInstance::StaticLighting[0x3], py::return_value_policy::reference)
		;
	...
	py::class_< FNavMeshPathGoalEvaluatorCacheDatum >(m, "FNavMeshPathGoalEvaluatorCacheDatum")
		...
		.def_readwrite("List[0x5]", &FNavMeshPathGoalEvaluatorCacheDatum::List[0x5], py::return_value_policy::reference)
		;
	...
	py::class_< FNavMeshPathConstraintCacheDatum >(m, "FNavMeshPathConstraintCacheDatum")
		...
		.def_readwrite("List[0x5]", &FNavMeshPathConstraintCacheDatum::List[0x5], py::return_value_policy::reference)
		;
	...
	py::class_< FGBXNavMeshPoly >(m, "FGBXNavMeshPoly")
		.def_readwrite("Verts[0x6]", &FGBXNavMeshPoly::Verts[0x6])
		.def_readwrite("ConnectedPolys[0x6]", &FGBXNavMeshPoly::ConnectedPolys[0x6])
		.def_readwrite("PolyDataIdx[0x2]", &FGBXNavMeshPoly::PolyDataIdx[0x2])
		;
	py::class_< FGBXNavmeshCrossLevelConnection >(m, "FGBXNavmeshCrossLevelConnection")
		.def_readwrite("EdgeIdx[0x2]", &FGBXNavmeshCrossLevelConnection::EdgeIdx[0x2])
		.def_readwrite("ConnectedNavmeshIdx[0x2]", &FGBXNavmeshCrossLevelConnection::ConnectedNavmeshIdx[0x2])
		.def_readwrite("PolyIdx[0x2]", &FGBXNavmeshCrossLevelConnection::PolyIdx[0x2])
		;
	py::class_< FGBXNavMeshSpecialMove >(m, "FGBXNavMeshSpecialMove")
		...
		.def_readwrite("UnknownData00[0x4]", &FGBXNavMeshSpecialMove::UnknownData00[0x4])
	...
	py::class_< FGBXNavMeshPolyData >(m, "FGBXNavMeshPolyData")
		...
		.def_readwrite("Obstacles[0xC]", &FGBXNavMeshPolyData::Obstacles[0xC])
		;
	...
	py::class_< FLandscapeWeightmapUsage >(m, "FLandscapeWeightmapUsage")
		.def_readwrite("ChannelUsage[0x4]", &FLandscapeWeightmapUsage::ChannelUsage[0x4], py::return_value_policy::reference)
		;
	...
	py::class_< FSearchState >(m, "FSearchState")
		...
		.def_readwrite("UnknownData00[0x4]", &FSearchState::UnknownData00[0x4])
	...
	py::class_< FUIDataStoreInputAlias >(m, "FUIDataStoreInputAlias")
		...
		.def_readwrite("PlatformInputKeys[0x3]", &FUIDataStoreInputAlias::PlatformInputKeys[0x3], py::return_value_policy::reference)
		;
	...
	py::class_< FInventorySerialNumber >(m, "FInventorySerialNumber")
		.def_readwrite("Buffer[0x28]", &FInventorySerialNumber::Buffer[0x28])
