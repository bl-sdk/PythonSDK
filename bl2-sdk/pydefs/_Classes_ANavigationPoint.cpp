...
{
    class_< ANavigationPoint, bases< AActor >  , boost::noncopyable>("ANavigationPoint", no_init)
        ...
        .def("StaticClass", &ANavigationPoint::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetNearestAreaNavPointTo_Script", &ANavigationPoint::GetNearestAreaNavPointTo_Script, return_value_policy< reference_existing_object >())
        ...
        .def("GetNearestNavToPoint", &ANavigationPoint::GetNearestNavToPoint, return_value_policy< reference_existing_object >())
        .def("GetNearestNavToActor", &ANavigationPoint::GetNearestNavToActor, return_value_policy< reference_existing_object >())
        ...
        .def("GetReachSpecTo", &ANavigationPoint::GetReachSpecTo, return_value_policy< reference_existing_object >())
