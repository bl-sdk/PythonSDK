...
{
    class_< UGameEngine, bases< USubsystem >  , boost::noncopyable>("UGameEngine", no_init)
        ...
        .def("StaticClass", &UGameEngine::StaticClass, return_value_policy< reference_existing_object >())
        .def("GetAdManager", &UGameEngine::GetAdManager, return_value_policy< reference_existing_object >())
        .def("GetDLCOfferEnumerator", &UGameEngine::GetDLCOfferEnumerator, return_value_policy< reference_existing_object >())
        .def("GetDLCManager", &UGameEngine::GetDLCManager, return_value_policy< reference_existing_object >())
        .def("GetDLCEnumerator", &UGameEngine::GetDLCEnumerator, return_value_policy< reference_existing_object >())
        .def("GetOnlineSubsystem", &UGameEngine::GetOnlineSubsystem, return_value_policy< reference_existing_object >())
        ...
        .def("GetFacebookIntegration", &UEngine::GetFacebookIntegration, return_value_policy< reference_existing_object >())
        ...
        .def("GetWorldPostProcessChain", &UEngine::GetWorldPostProcessChain, return_value_policy< reference_existing_object >())
        .def("GetEngine", &UEngine::GetEngine, return_value_policy< reference_existing_object >())
        ...
        .def("GetAkAudioDevice", &UEngine::GetAkAudioDevice, return_value_policy< reference_existing_object >())
        .def("GetAudioDevice", &UEngine::GetAudioDevice, return_value_policy< reference_existing_object >())
        .def("IsStereoscopic3D", &UEngine::IsStereoscopic3D)
        .def("IsSplitScreen", &UEngine::IsSplitScreen)
        .def("GetAdditionalFont", &UEngine::GetAdditionalFont, return_value_policy< reference_existing_object >())
        .def("GetSubtitleFont", &UEngine::GetSubtitleFont, return_value_policy< reference_existing_object >())
        .def("GetLargeFont", &UEngine::GetLargeFont, return_value_policy< reference_existing_object >())
        .def("GetMediumFont", &UEngine::GetMediumFont, return_value_policy< reference_existing_object >())
        .def("GetSmallFont", &UEngine::GetSmallFont, return_value_policy< reference_existing_object >())
        .def("GetTinyFont", &UEngine::GetTinyFont, return_value_policy< reference_existing_object >())
        .def("GetBuildDate", &UEngine::GetBuildDate)
        .def("GetCurrentWorldInfo", &UEngine::GetCurrentWorldInfo, return_value_policy< reference_existing_object >())
