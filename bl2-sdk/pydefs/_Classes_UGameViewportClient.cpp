...
{
    class_< UGameViewportClient, bases< UObject >  , boost::noncopyable>("UGameViewportClient", no_init)
        ...
        .def_readonly("ProgressMessage", &UGameViewportClient::ProgressMessage)
        ...
        .def("StaticClass", &UGameViewportClient::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetPlayerOwner", &UGameViewportClient::GetPlayerOwner, return_value_policy< reference_existing_object >())
        ...
        .def("eventFindPlayerByControllerId", &UGameViewportClient::eventFindPlayerByControllerId, return_value_policy< reference_existing_object >())
        .def("eventRemovePlayer", &UGameViewportClient::eventRemovePlayer)
        .def("eventCreatePlayer", &UGameViewportClient::eventCreatePlayer, return_value_policy< reference_existing_object >())
        ...
        .def("GetCustomInteractionClass", &UGameViewportClient::GetCustomInteractionClass, return_value_policy< reference_existing_object >())
