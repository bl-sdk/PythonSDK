...
{
    class_< AWillowInventoryManager, bases< AInventoryManager >  , boost::noncopyable>("AWillowInventoryManager", no_init)
        ...
        .def("StaticClass", &AWillowInventoryManager::StaticClass, return_value_policy< reference_existing_object >())
        .def("InternalSetCurrentWeapon", &AWillowInventoryManager::InternalSetCurrentWeapon)
        .def("GetEquippedAnalogue", &AWillowInventoryManager::GetEquippedAnalogue, return_value_policy< reference_existing_object >())
        .def("GetBlackMarketFeaturedItem", &AWillowInventoryManager::GetBlackMarketFeaturedItem, return_value_policy< reference_existing_object >())
        ...
        .def("GetCurrentClassMod", &AWillowInventoryManager::GetCurrentClassMod, return_value_policy< reference_existing_object >())
        ...
        .def("GetWeaponInSlot", &AWillowInventoryManager::GetWeaponInSlot, return_value_policy< reference_existing_object >())
        ...
        .def("FindBestHolsteredWeapon", &AWillowInventoryManager::FindBestHolsteredWeapon, return_value_policy< reference_existing_object >())
        ...
        .def("GetOwningPlayerController", &AWillowInventoryManager::GetOwningPlayerController, return_value_policy< reference_existing_object >())
        ...
        .def("FindLeastValuableWeapon", &AWillowInventoryManager::FindLeastValuableWeapon, return_value_policy< reference_existing_object >())
        .def("FindLeastValuableItem", &AWillowInventoryManager::FindLeastValuableItem, return_value_policy< reference_existing_object >())
