...
{
    class_< AWillowEquipAbleItem, bases< AWillowInventory >  , boost::noncopyable>("AWillowEquipAbleItem", no_init)
        ...
        .def("StaticClass", &AWillowEquipAbleItem::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("CreateItemFromSerialNumber", &AWillowItem::CreateItemFromSerialNumber, return_value_policy< reference_existing_object >())
        ...
        .def("CreateItemFromDef", &AWillowItem::CreateItemFromDef, return_value_policy< reference_existing_object >())
        .def("eventGetCategoryKey", &AWillowItem::eventGetCategoryKey)
        .def("CreateItemFromMemento", &AWillowItem::CreateItemFromMemento, return_value_policy< reference_existing_object >())
        ...
        .def("GetDroppedImpactDefinition", &AWillowItem::GetDroppedImpactDefinition, return_value_policy< reference_existing_object >())
        ...
        .def("GetPresentationDefinition", &AWillowItem::GetPresentationDefinition, return_value_policy< reference_existing_object >())
        ...
        .def("CreateClone", &AWillowItem::CreateClone, return_value_policy< reference_existing_object >())
        .def("DropFrom", &AWillowItem::DropFrom, return_value_policy< reference_existing_object >())
        ...
        .def("GetProjectileDefinition", &AWillowItem::GetProjectileDefinition, return_value_policy< reference_existing_object >())
        .def("UpdateUIStateModifierCompareValues", &AWillowItem::UpdateUIStateModifierCompareValues)
        .def("GetAttributePresentationOverride", &AWillowItem::GetAttributePresentationOverride, return_value_policy< reference_existing_object >())
        ...
        .def("SelectNamePartFromList", &AWillowItem::SelectNamePartFromList, return_value_policy< reference_existing_object >())
        ...
        .def("ClonePrimaryMesh", &AWillowItem::ClonePrimaryMesh, return_value_policy< reference_existing_object >())
        ...
        .def("eventInitConstructPreview", &AWillowItem::eventInitConstructPreview, return_value_policy< reference_existing_object >())
        .def("BuildItemMaterial", &AWillowItem::BuildItemMaterial, return_value_policy< reference_existing_object >())
        .def("BuildCompositeMesh", &AWillowItem::BuildCompositeMesh, return_value_policy< reference_existing_object >())
