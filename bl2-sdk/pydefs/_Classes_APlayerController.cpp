...
{
    class_< APlayerController, bases< UObject >  , boost::noncopyable>("APlayerController", no_init)
        ...
        .def_readonly("UnknownData00", &APlayerController::UnknownData00)
        ...
        .def_readonly("LastBroadcastString", &APlayerController::LastBroadcastString)
        ...
        .def_readonly("GoalList", &AController::GoalList)
        ...
        .def("StaticClass", &APlayerController::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("eventGetAchievementProgression", &APlayerController::eventGetAchievementProgression)
        ...
        .def("GetSplitscreenPlayerByIndex", &APlayerController::GetSplitscreenPlayerByIndex, return_value_policy< reference_existing_object >())
        .def("IsSplitscreenPlayer", &APlayerController::IsSplitscreenPlayer)
        ...
        .def("ClientTravelToSession", &APlayerController::ClientTravelToSession)
        ...
        .def("GetPlayerControllerFromNetId", &APlayerController::GetPlayerControllerFromNetId, return_value_policy< reference_existing_object >())
        ...
        .def("GetUIController", &APlayerController::GetUIController, return_value_policy< reference_existing_object >())
        ...
        .def("GetNextViewablePlayer", &APlayerController::GetNextViewablePlayer, return_value_policy< reference_existing_object >())
        ...
        .def("GetViewTarget", &APlayerController::GetViewTarget, return_value_policy< reference_existing_object >())
        ...
        .def("GetFreeMove", &APlayerController::GetFreeMove, return_value_policy< reference_existing_object >())
        ...
        .def("CreateTTSSoundCue", &APlayerController::CreateTTSSoundCue, return_value_policy< reference_existing_object >())
        ...
        .def("GetPooledAudioComponent", &APlayerController::GetPooledAudioComponent, return_value_policy< reference_existing_object >())
        ...
        .def("GetOnlineSubsystem", &APlayerController::GetOnlineSubsystem, return_value_policy< reference_existing_object >())
        ...
        .def("eventPeerReceivedMigratedSession", &APlayerController::eventPeerReceivedMigratedSession)
        .def("TellPeerToTravelToSession", &APlayerController::TellPeerToTravelToSession)
        ...
        .def("GetCurrentSearchClass", &APlayerController::GetCurrentSearchClass, return_value_policy< reference_existing_object >())
        ...
        .def("SpawnCoverReplicator", &APlayerController::SpawnCoverReplicator, return_value_policy< reference_existing_object >())
        ...
        .def("EnableActorHeadTracking", &APlayerController::EnableActorHeadTracking)
        ...
        .def("GetInstanceDataPawn", &AController::GetInstanceDataPawn, return_value_policy< reference_existing_object >())
        .def("ShouldSwitchToBestWeapon", &AController::ShouldSwitchToBestWeapon)
        .def("GetWorldPawn", &AController::GetWorldPawn, return_value_policy< reference_existing_object >())
        ...
        .def("eventGetClassDefinition", &AController::eventGetClassDefinition, return_value_policy< reference_existing_object >())
        ...
        .def("FindPathToIntercept", &AController::FindPathToIntercept, return_value_policy< reference_existing_object >())
        .def("FindRandomDest", &AController::FindRandomDest, return_value_policy< reference_existing_object >())
        .def("FindPathTowardNearest", &AController::FindPathTowardNearest, return_value_policy< reference_existing_object >())
        .def("FindPathToward", &AController::FindPathToward, return_value_policy< reference_existing_object >())
        .def("FindPathTo", &AController::FindPathTo, return_value_policy< reference_existing_object >())
        ...
        .def("PickTarget", &AController::PickTarget, return_value_policy< reference_existing_object >())
