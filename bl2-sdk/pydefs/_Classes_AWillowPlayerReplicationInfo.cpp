...
void Export_pystes_AWillowPlayerReplicationInfo()
{
    py::class_< AWillowPlayerReplicationInfo,  APlayerReplicationInfo   >("AWillowPlayerReplicationInfo")
        ...
        .def_readonly("Currency", &AWillowPlayerReplicationInfo::Currency)
        ...
        .def_readonly("ReplicatedNouns", &AWillowPlayerReplicationInfo::ReplicatedNouns)
        ...
        .def_readonly("LocalCustomizations", &AWillowPlayerReplicationInfo::LocalCustomizations)
        .def_readonly("RemoteCustomizations", &AWillowPlayerReplicationInfo::RemoteCustomizations)
