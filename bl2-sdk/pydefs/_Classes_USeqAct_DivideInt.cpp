...
{
    py::class_< USeqAct_DivideInt,  USeqAct_SetSequenceVariable   >("USeqAct_DivideInt")
        ...
        .def("StaticClass", &USeqAct_DivideInt::StaticClass, py::return_value_policy::reference)
