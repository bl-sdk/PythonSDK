...
{
    py::class_< UDownloadableCharacterDefinition,  UGBXDefinition   >("UDownloadableCharacterDefinition")
        ...
        .def("StaticClass", &UDownloadableCharacterDefinition::StaticClass, py::return_value_policy::reference)
