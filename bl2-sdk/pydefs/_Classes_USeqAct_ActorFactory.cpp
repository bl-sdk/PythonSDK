...
{
    class_< USeqAct_ActorFactory, bases< USeqAct_Latent >  , boost::noncopyable>("USeqAct_ActorFactory", no_init)
        ...
        .def("StaticClass", &USeqAct_ActorFactory::StaticClass, return_value_policy< reference_existing_object >())
