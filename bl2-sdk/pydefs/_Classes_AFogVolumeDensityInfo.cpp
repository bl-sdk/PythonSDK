...
{
    class_< AFogVolumeDensityInfo, bases< AInfo >  , boost::noncopyable>("AFogVolumeDensityInfo", no_init)
        ...
        .def("StaticClass", &AFogVolumeDensityInfo::StaticClass, return_value_policy< reference_existing_object >())
