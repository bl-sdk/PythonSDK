...
{
    class_< UFrontendGFxMovie, bases< UWillowGFxMovie3D >  , boost::noncopyable>("UFrontendGFxMovie", no_init)
        ...
        .def("StaticClass", &UFrontendGFxMovie::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("OpenMovieLink", &UFrontendGFxMovie::OpenMovieLink, return_value_policy< reference_existing_object >())
        .def("PlayMovieLink", &UFrontendGFxMovie::PlayMovieLink, return_value_policy< reference_existing_object >())
        ...
        .def("GetSaveGameTravelStationDefinition", &UFrontendGFxMovie::GetSaveGameTravelStationDefinition, return_value_policy< reference_existing_object >())
        ...
        .def("GetSplitscreenHelper", &UFrontendGFxMovie::GetSplitscreenHelper, return_value_policy< reference_existing_object >())
        .def("GetPlayerDetailsMovieDef", &UFrontendGFxMovie::GetPlayerDetailsMovieDef, return_value_policy< reference_existing_object >())
        ...
        .def("GetWPCOwner", &UFrontendGFxMovie::GetWPCOwner, return_value_policy< reference_existing_object >())
