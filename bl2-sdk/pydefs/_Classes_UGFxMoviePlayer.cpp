...
{
    class_< UGFxMoviePlayer, bases< UObject >  , boost::noncopyable>("UGFxMoviePlayer", no_init)
        ...
        .def("StaticClass", &UGFxMoviePlayer::StaticClass, return_value_policy< reference_existing_object >())
