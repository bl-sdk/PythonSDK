...
{
    class_< AWillowPopulationPoint, bases< APopulationPoint >  , boost::noncopyable>("AWillowPopulationPoint", no_init)
        ...
        .def("StaticClass", &AWillowPopulationPoint::StaticClass, return_value_policy< reference_existing_object >())
