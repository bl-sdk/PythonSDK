...
void Export_pystes_AActor(py::object m)
{
    py::class_< AActor,  UObject   >(m, "AActor")
		...
		.def("VisibleDamageableActors", [](AActor &self, class UClass* BaseClass, float Radius, struct FVector Loc, unsigned long bIgnoreHidden, struct FVector Extent, unsigned long bTraceActors, class UClass* InterfaceClass, unsigned long bSkipTraceTest, class AActor* IgnoreActor, struct FTraceHitInfo* HitInfo) { class AActor** Actor = 0;  self.VisibleDamageableActors(BaseClass, Radius, Loc, bIgnoreHidden, Extent, bTraceActors, InterfaceClass, bSkipTraceTest, IgnoreActor, Actor, HitInfo); return *Actor; }, py::return_value_policy::reference)
