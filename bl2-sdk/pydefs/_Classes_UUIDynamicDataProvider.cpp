...
{
    py::class_< UUIDynamicDataProvider,  UUIDataProvider   >("UUIDynamicDataProvider")
        ...
        .def("StaticClass", &UUIDynamicDataProvider::StaticClass, py::return_value_policy::reference)
