...
{
    class_< AWillowInteractiveObject, bases< AActor >  , boost::noncopyable>("AWillowInteractiveObject", no_init)
        ...
        .def_readonly("bCanBeUsed", &AWillowInteractiveObject::bCanBeUsed)
        .def_readonly("bCostsToUse", &AWillowInteractiveObject::bCostsToUse)
        .def_readonly("CostsToUseType", &AWillowInteractiveObject::CostsToUseType)
        ...
        .def_readonly("CostsToUseAmount", &AWillowInteractiveObject::CostsToUseAmount)
        ...
        .def_readonly("UnknownData00", &AWillowInteractiveObject::UnknownData00)
        ...
        .def_readonly("InteractionIconOverride", &AWillowInteractiveObject::InteractionIconOverride)
        ...
        .def_readonly("UnknownData01", &AWillowInteractiveObject::UnknownData01)
        ...
        .def("StaticClass", &AWillowInteractiveObject::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetObstacleActor", &AWillowInteractiveObject::GetObstacleActor, return_value_policy< reference_existing_object >())
        ...
        .def("GetDialogComponent", &AWillowInteractiveObject::GetDialogComponent, return_value_policy< reference_existing_object >())
        .def("GetDialogNameTag", &AWillowInteractiveObject::GetDialogNameTag, return_value_policy< reference_existing_object >())
        ...
        .def("GetPatsy", &AWillowInteractiveObject::GetPatsy, return_value_policy< reference_existing_object >())
        .def("IsBeingHealed", &AWillowInteractiveObject::IsBeingHealed)
        .def("SetBeingHealed", &AWillowInteractiveObject::SetBeingHealed)
        .def("GetControllerResponsibleForDamage", &AWillowInteractiveObject::GetControllerResponsibleForDamage, return_value_policy< reference_existing_object >())
        .def("GetInstigator", &AWillowInteractiveObject::GetInstigator, return_value_policy< reference_existing_object >())
        ...
        .def("GetLightProjMgrFor", &AWillowInteractiveObject::GetLightProjMgrFor, return_value_policy< reference_existing_object >())
        ...
        .def("GetSkelMesh", &AWillowInteractiveObject::GetSkelMesh, return_value_policy< reference_existing_object >())
        .def("GetSMComponent", &AWillowInteractiveObject::GetSMComponent, return_value_policy< reference_existing_object >())
        .def("GetActor", &AWillowInteractiveObject::GetActor, return_value_policy< reference_existing_object >())
        ...
        .def("ShieldAbsorbedAmmo", &AWillowInteractiveObject::ShieldAbsorbedAmmo)
        ...
        .def("GetHitRegionHealthValues", &AWillowInteractiveObject::GetHitRegionHealthValues)
        .def("GetHitRegionForTakenDamage", &AWillowInteractiveObject::GetHitRegionForTakenDamage, return_value_policy< reference_existing_object >())
        ...
        .def("GetDefaultAllegiance", &AWillowInteractiveObject::GetDefaultAllegiance, return_value_policy< reference_existing_object >())
        .def("GetObjectAllegiance", &AWillowInteractiveObject::GetObjectAllegiance, return_value_policy< reference_existing_object >())
        ...
        .def("GFx_GetMovieActor", &AWillowInteractiveObject::GFx_GetMovieActor, return_value_policy< reference_existing_object >())
        ...
        .def("eventGetInstancedDesignerAttribute", &AWillowInteractiveObject::eventGetInstancedDesignerAttribute, return_value_policy< reference_existing_object >())
        .def("CreateDesignerAttribute", &AWillowInteractiveObject::CreateDesignerAttribute, return_value_policy< reference_existing_object >())
        ...
        .def("ReduceInteractiveObjectDamage", &AWillowInteractiveObject::ReduceInteractiveObjectDamage)
        .def("GetLastDamagedByController", &AWillowInteractiveObject::GetLastDamagedByController, return_value_policy< reference_existing_object >())
        ...
        .def("GetMesh", &AWillowInteractiveObject::GetMesh, return_value_policy< reference_existing_object >())
        .def("FindAnimNode", &AWillowInteractiveObject::FindAnimNode, return_value_policy< reference_existing_object >())
        ...
        .def("GetBodyInfoProvider", &AWillowInteractiveObject::GetBodyInfoProvider, return_value_policy< reference_existing_object >())
        ...
        .def("GetAssociatedChallenge", &AWillowInteractiveObject::GetAssociatedChallenge, return_value_policy< reference_existing_object >())
        ...
        .def("GetAttributeContextSource", &AWillowInteractiveObject::GetAttributeContextSource, return_value_policy< reference_existing_object >())
        .def("GetBoundingSphereRadius", &AWillowInteractiveObject::GetBoundingSphereRadius)
        .def("GetHitRegions", &AWillowInteractiveObject::GetHitRegions)
        .def("AttachEmitter", &AWillowInteractiveObject::AttachEmitter)
        .def("GetDefaultStatusEffectsParticleSystemTemplate", &AWillowInteractiveObject::GetDefaultStatusEffectsParticleSystemTemplate, return_value_policy< reference_existing_object >())
        .def("GetDefaultStatusEffectSockets", &AWillowInteractiveObject::GetDefaultStatusEffectSockets)
        .def("GetStatusEffectsComponent", &AWillowInteractiveObject::GetStatusEffectsComponent, return_value_policy< reference_existing_object >())
        ...
        .def("GetTargetableActor", &AWillowInteractiveObject::GetTargetableActor, return_value_policy< reference_existing_object >())
