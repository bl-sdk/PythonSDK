...
{
    class_< UMeshBeaconClient, bases< UMeshBeacon >  , boost::noncopyable>("UMeshBeaconClient", no_init)
        ...
        .def("StaticClass", &UMeshBeaconClient::StaticClass, return_value_policy< reference_existing_object >())
