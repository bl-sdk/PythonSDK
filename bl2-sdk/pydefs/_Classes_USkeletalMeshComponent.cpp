...
{
    class_< USkeletalMeshComponent, bases< UMeshComponent >  , boost::noncopyable>("USkeletalMeshComponent", no_init)
        ...
        .def_readonly("UnknownData00", &USkeletalMeshComponent::UnknownData00)
        ...
        .def_readonly("UnknownData01", &USkeletalMeshComponent::UnknownData01)
        ...
        .def("StaticClass", &USkeletalMeshComponent::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("FindBodyInstanceNamed", &USkeletalMeshComponent::FindBodyInstanceNamed, return_value_policy< reference_existing_object >())
        ...
        .def("FindMorphNode", &USkeletalMeshComponent::FindMorphNode, return_value_policy< reference_existing_object >())
        .def("FindSkelControl", &USkeletalMeshComponent::FindSkelControl, return_value_policy< reference_existing_object >())
        .def("AllAnimNodes", &USkeletalMeshComponent::AllAnimNodes)
        .def("FindAnimNode", &USkeletalMeshComponent::FindAnimNode, return_value_policy< reference_existing_object >())
        .def("FindMorphTarget", &USkeletalMeshComponent::FindMorphTarget, return_value_policy< reference_existing_object >())
        ...
        .def("FindAnimSequence", &USkeletalMeshComponent::FindAnimSequence, return_value_policy< reference_existing_object >())
        ...
        .def("FindComponentAttachedToBone", &USkeletalMeshComponent::FindComponentAttachedToBone, return_value_policy< reference_existing_object >())
        .def("GetSocketBoneName", &USkeletalMeshComponent::GetSocketBoneName)
        .def("GetSocketByName", &USkeletalMeshComponent::GetSocketByName, return_value_policy< reference_existing_object >())
