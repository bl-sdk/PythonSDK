...
{
    class_< AWillowItem, bases< AWillowInventory >  , boost::noncopyable>("AWillowItem", no_init)
        ...
        .def("StaticClass", &AWillowItem::StaticClass, return_value_policy< reference_existing_object >())
