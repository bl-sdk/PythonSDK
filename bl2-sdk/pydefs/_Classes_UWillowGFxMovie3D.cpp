...
{
    class_< UWillowGFxMovie3D, bases< UWillowGFxMovie >  , boost::noncopyable>("UWillowGFxMovie3D", no_init)
        ...
        .def_readonly("UnknownData00", &UWillowGFxMovie3D::UnknownData00)
        .def_readwrite("CachedViewMat", &UWillowGFxMovie3D::CachedViewMat)
        .def_readwrite("CachedProjMat", &UWillowGFxMovie3D::CachedProjMat)
        .def("StaticClass", &UWillowGFxMovie3D::StaticClass, return_value_policy< reference_existing_object >())
