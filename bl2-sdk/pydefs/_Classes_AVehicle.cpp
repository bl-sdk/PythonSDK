...
{
    class_< AVehicle, bases< APawn >  , boost::noncopyable>("AVehicle", no_init)
        ...
        .def("StaticClass", &AVehicle::StaticClass, return_value_policy< reference_existing_object >())
        .def("GetOccupantWhoCanPickup", &AVehicle::GetOccupantWhoCanPickup, return_value_policy< reference_existing_object >())
        ...
        .def("GetCollisionDamageInstigator", &AVehicle::GetCollisionDamageInstigator, return_value_policy< reference_existing_object >())
        ...
        .def("SetKillInstigator", &AVehicle::SetKillInstigator, return_value_policy< reference_existing_object >())
        ...
        .def("GetDriverController", &AVehicle::GetDriverController, return_value_policy< reference_existing_object >())
        .def("GetVehicleBase", &AVehicle::GetVehicleBase, return_value_policy< reference_existing_object >())
