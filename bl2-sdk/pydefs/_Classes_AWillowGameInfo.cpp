...
{
    class_< AWillowGameInfo, bases< AGearboxGameInfo >  , boost::noncopyable>("AWillowGameInfo", no_init)
        ...
        .def("StaticClass", &AWillowGameInfo::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetAIBlackboard", &AWillowGameInfo::GetAIBlackboard, return_value_policy< reference_existing_object >())
        .def("InitSequence", &AWillowGameInfo::InitSequence)
        .def("GetAllegiance", &AWillowGameInfo::GetAllegiance, return_value_policy< reference_existing_object >())
        .def("GetAIDefinition", &AWillowGameInfo::GetAIDefinition, return_value_policy< reference_existing_object >())
        .def("GetAIComponent", &AWillowGameInfo::GetAIComponent, return_value_policy< reference_existing_object >())
        .def("GetAIParent", &AWillowGameInfo::GetAIParent, return_value_policy< reference_existing_object >())
        .def("GetAILocation", &AWillowGameInfo::GetAILocation)
        .def("GetAIActor", &AWillowGameInfo::GetAIActor, return_value_policy< reference_existing_object >())
        ...
        .def("SpawnDefaultPawnFor", &AWillowGameInfo::SpawnDefaultPawnFor, return_value_policy< reference_existing_object >())
        ...
        .def("GetBlackMarketUpgradeManager", &AWillowGameInfo::GetBlackMarketUpgradeManager, return_value_policy< reference_existing_object >())
        .def("GetPlayerStatsNotifier", &AWillowGameInfo::GetPlayerStatsNotifier, return_value_policy< reference_existing_object >())
        .def("GetCombatMusicManager", &AWillowGameInfo::GetCombatMusicManager, return_value_policy< reference_existing_object >())
        .def("GetChallengeManager", &AWillowGameInfo::GetChallengeManager, return_value_policy< reference_existing_object >())
        .def("GetPlayerInteractionManager", &AWillowGameInfo::GetPlayerInteractionManager, return_value_policy< reference_existing_object >())
        .def("GetSkillManager", &AWillowGameInfo::GetSkillManager, return_value_policy< reference_existing_object >())
        .def("eventLogin", &AWillowGameInfo::eventLogin, return_value_policy< reference_existing_object >())
        ...
        .def("FindPlayerStart", &AWillowGameInfo::FindPlayerStart, return_value_policy< reference_existing_object >())
        ...
        .def("eventGetInstancedDesignerAttribute", &AWillowGameInfo::eventGetInstancedDesignerAttribute, return_value_policy< reference_existing_object >())
        .def("CreateDesignerAttribute", &AWillowGameInfo::CreateDesignerAttribute, return_value_policy< reference_existing_object >())
