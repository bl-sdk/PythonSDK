...
{
    class_< AWillowInventory, bases< AActor >  , boost::noncopyable>("AWillowInventory", no_init)
        ...
        .def("StaticClass", &AWillowInventory::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("eventClonePrimaryMeshForUI", &AWillowInventory::eventClonePrimaryMeshForUI, return_value_policy< reference_existing_object >())
        .def("CloneInventorySkelMeshComponent", &AWillowInventory::CloneInventorySkelMeshComponent, return_value_policy< reference_existing_object >())
        .def("eventCloneAppearance", &AWillowInventory::eventCloneAppearance)
        .def("ClonePrimaryMesh", &AWillowInventory::ClonePrimaryMesh, return_value_policy< reference_existing_object >())
        .def("AttachMeshToPickup", &AWillowInventory::AttachMeshToPickup)
        .def("GetModelName", &AWillowInventory::GetModelName)
        .def("GetDroppedImpactDefinition", &AWillowInventory::GetDroppedImpactDefinition, return_value_policy< reference_existing_object >())
        ...
        .def("GetPawnController", &AWillowInventory::GetPawnController, return_value_policy< reference_existing_object >())
        ...
        .def("CreateClone", &AWillowInventory::CreateClone, return_value_policy< reference_existing_object >())
        ...
        .def("CreatePickup", &AWillowInventory::CreatePickup, return_value_policy< reference_existing_object >())
        .def("GetPickup", &AWillowInventory::GetPickup, return_value_policy< reference_existing_object >())
        .def("eventDropFromNative", &AWillowInventory::eventDropFromNative, return_value_policy< reference_existing_object >())
        .def("DropFrom", &AWillowInventory::DropFrom, return_value_policy< reference_existing_object >())
        ...
        .def("eventSpawnPickup", &AWillowInventory::eventSpawnPickup, return_value_policy< reference_existing_object >())
        .def("eventInitConstructPreview", &AWillowInventory::eventInitConstructPreview, return_value_policy< reference_existing_object >())
        ...
        .def("GetPresentationDefinition", &AWillowInventory::GetPresentationDefinition, return_value_policy< reference_existing_object >())
        ...
        .def("StaticCreateCompositeMesh", &AWillowInventory::StaticCreateCompositeMesh, return_value_policy< reference_existing_object >())
        ...
        .def("GetManufacturer", &AWillowInventory::GetManufacturer, return_value_policy< reference_existing_object >())
        .def("GetInventoryDefinition", &AWillowInventory::GetInventoryDefinition, return_value_policy< reference_existing_object >())
        ...
        .def("CreateInventoryFromSerialNumberString", &AWillowInventory::CreateInventoryFromSerialNumberString, return_value_policy< reference_existing_object >())
        .def("CreateInventoryFromSerialNumber", &AWillowInventory::CreateInventoryFromSerialNumber, return_value_policy< reference_existing_object >())
