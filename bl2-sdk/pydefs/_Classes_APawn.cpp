...
{
    class_< APawn, bases< AActor >  , boost::noncopyable>("APawn", no_init)
        ...
        .def_readonly("FlashLocation", &APawn::FlashLocation)
        ...
        .def_readonly("UnknownData00", &APawn::UnknownData00)
        ...
        .def("StaticClass", &APawn::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetPatsy", &APawn::GetPatsy, return_value_policy< reference_existing_object >())
        ...
        .def("GetRigidBodyMesh", &APawn::GetRigidBodyMesh, return_value_policy< reference_existing_object >())
        .def("DestroyHealthPool", &APawn::DestroyHealthPool)
        .def("SetHealthResourcePoolDefinition", &APawn::SetHealthResourcePoolDefinition)
        ...
        .def("FindAnimNode", &APawn::FindAnimNode, return_value_policy< reference_existing_object >())
        ...
        .def("CreatePathGoalEvaluator", &APawn::CreatePathGoalEvaluator, return_value_policy< reference_existing_object >())
        .def("CreatePathConstraint", &APawn::CreatePathConstraint, return_value_policy< reference_existing_object >())
        ...
        .def("FindInventoryType", &APawn::FindInventoryType, return_value_policy< reference_existing_object >())
        .def("eventCreateInventory", &APawn::eventCreateInventory, return_value_policy< reference_existing_object >())
        ...
        .def("GetVehicleBase", &APawn::GetVehicleBase, return_value_policy< reference_existing_object >())
        ...
        .def("GetTeam", &APawn::GetTeam, return_value_policy< reference_existing_object >())
        ...
        .def("SetKillInstigator", &APawn::SetKillInstigator, return_value_policy< reference_existing_object >())
        ...
        .def("AdjustDamage", &APawn::AdjustDamage)
        ...
        .def("GetController", &APawn::GetController, return_value_policy< reference_existing_object >())
        ...
        .def("GetBoundingCylinder", &APawn::GetBoundingCylinder)
        ...
        .def("GetBestAnchor", &APawn::GetBestAnchor, return_value_policy< reference_existing_object >())
        ...
        .def("eventGetActorFaceFXAsset", &APawn::eventGetActorFaceFXAsset, return_value_policy< reference_existing_object >())
        ...
        .def("eventGetFaceFXAudioComponent", &APawn::eventGetFaceFXAudioComponent, return_value_policy< reference_existing_object >())
        ...
        .def("GetExpInfo", &APawn::GetExpInfo)
        ...
        .def("GetDefaultAllegiance", &APawn::GetDefaultAllegiance, return_value_policy< reference_existing_object >())
        .def("GetObjectAllegiance", &APawn::GetObjectAllegiance, return_value_policy< reference_existing_object >())
        ...
        .def("GetTargetableActor", &APawn::GetTargetableActor, return_value_policy< reference_existing_object >())
