...
{
    class_< UStatusMenuExGFxMovie, bases< UWillowGFxMovie3D >  , boost::noncopyable>("UStatusMenuExGFxMovie", no_init)
        ...
        .def("StaticClass", &UStatusMenuExGFxMovie::StaticClass, return_value_policy< reference_existing_object >())
        ...
        .def("GetHighestPlotMissionDependency", &UStatusMenuExGFxMovie::GetHighestPlotMissionDependency, return_value_policy< reference_existing_object >())
        .def("ArePlotMissionsInSequence", &UStatusMenuExGFxMovie::ArePlotMissionsInSequence)
        .def("GetHighestChainedPlotMissionCompleted", &UStatusMenuExGFxMovie::GetHighestChainedPlotMissionCompleted, return_value_policy< reference_existing_object >())
        ...
        .def("GetEquippedCellInventory", &UStatusMenuExGFxMovie::GetEquippedCellInventory, return_value_policy< reference_existing_object >())
        .def("GetHighlightedCellEntry", &UStatusMenuExGFxMovie::GetHighlightedCellEntry, return_value_policy< reference_existing_object >())
        .def("GetHighlightedRightSideEntry", &UStatusMenuExGFxMovie::GetHighlightedRightSideEntry, return_value_policy< reference_existing_object >())
        .def("GetHighlightedLeftSideEntry", &UStatusMenuExGFxMovie::GetHighlightedLeftSideEntry, return_value_policy< reference_existing_object >())
        .def("GetCurrentHighlightedObject", &UStatusMenuExGFxMovie::GetCurrentHighlightedObject, return_value_policy< reference_existing_object >())
