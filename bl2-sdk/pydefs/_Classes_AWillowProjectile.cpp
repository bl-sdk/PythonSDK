...
{
    class_< AWillowProjectile, bases< AProjectile >  , boost::noncopyable>("AWillowProjectile", no_init)
        ...
        .def("StaticClass", &AWillowProjectile::StaticClass, return_value_policy< reference_existing_object >())
        .def("GetLightProjMgrFor", &AWillowProjectile::GetLightProjMgrFor, return_value_policy< reference_existing_object >())
        .def("CheckAIAvoidance", &AWillowProjectile::CheckAIAvoidance)
        .def("GetObstacleInfo", &AWillowProjectile::GetObstacleInfo)
        .def("GetObstacleActor", &AWillowProjectile::GetObstacleActor, return_value_policy< reference_existing_object >())
        ...
        .def("GetPatsy", &AWillowProjectile::GetPatsy, return_value_policy< reference_existing_object >())
        ...
        .def("GetBodyInfoProvider", &AWillowProjectile::GetBodyInfoProvider, return_value_policy< reference_existing_object >())
        ...
        .def("GetProjectileDefinition", &AWillowProjectile::GetProjectileDefinition, return_value_policy< reference_existing_object >())
        ...
        .def("GetTargetableActor", &AWillowProjectile::GetTargetableActor, return_value_policy< reference_existing_object >())
        ...
        .def("GetRigidBodyMesh", &AWillowProjectile::GetRigidBodyMesh, return_value_policy< reference_existing_object >())
        ...
        .def("GetAttachedToActor", &AWillowProjectile::GetAttachedToActor, return_value_policy< reference_existing_object >())
        ...
        .def("GetMesh", &AWillowProjectile::GetMesh, return_value_policy< reference_existing_object >())
        .def("FindAnimNode", &AWillowProjectile::FindAnimNode, return_value_policy< reference_existing_object >())
        .def("SetRotationRate", &AWillowProjectile::SetRotationRate)
        .def("GetCollisionRadius", &AWillowProjectile::GetCollisionRadius)
        .def("IsInTemporalField", &AWillowProjectile::IsInTemporalField, return_value_policy< reference_existing_object >())
        .def("GetHomingTarget", &AWillowProjectile::GetHomingTarget, return_value_policy< reference_existing_object >())
        ...
        .def("GetGearLiknessActor", &AWillowProjectile::GetGearLiknessActor, return_value_policy< reference_existing_object >())
        .def("SetGearLikenessActor", &AWillowProjectile::SetGearLikenessActor)
        .def("eventProjectileGetBehaviorContext", &AWillowProjectile::eventProjectileGetBehaviorContext, return_value_policy< reference_existing_object >())
        ...
        .def("GetInstigatingController", &AWillowProjectile::GetInstigatingController, return_value_policy< reference_existing_object >())
        ...
        .def("GetDefaultAllegiance", &AWillowProjectile::GetDefaultAllegiance, return_value_policy< reference_existing_object >())
        .def("GetObjectAllegiance", &AWillowProjectile::GetObjectAllegiance, return_value_policy< reference_existing_object >())
